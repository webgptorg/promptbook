export default [
    {
        ...
        sourceFile: './books/prepare-knowledge-from-markdown.book',
    },
    {
        title: 'Prepare Keywords',
        pipelineUrl: 'https://promptbook.studio/promptbook/prepare-knowledge-keywords.book',
        formfactorName: 'GENERIC',
        parameters: [
        ...
        sourceFile: './books/prepare-knowledge-keywords.book',
    },
    {
        title: 'Prepare Knowledge-piece Title',
        pipelineUrl: 'https://promptbook.studio/promptbook/prepare-knowledge-title.book',
        formfactorName: 'GENERIC',
        parameters: [
            { name: 'knowledgePieceContent', description: 'The content', isInput: true, isOutput: false },
        ...
        sourceFile: './books/prepare-knowledge-title.book',
    },
    {
        title: 'Prepare Persona',
        pipelineUrl: 'https://promptbook.studio/promptbook/prepare-persona.book',
        formfactorName: 'GENERIC',
        parameters: [
            {
                name: 'availableModels',
                description: 'List of available model names together with their descriptions as JSON',
                isInput: true,
                isOutput: false,
            },
            { name: 'personaDescription', description: 'Description of the persona', isInput: true, isOutput: false },
            {
                name: 'modelsRequirements',
        ...
        tasks: [
            {
                ...
                resultingParameterName: 'modelsRequirements',
                format: 'JSON',
                dependentParameterNames: ['availableModels', 'personaDescription'],
            },
        ],
        personas: [],
        preparations: [],
        ...
        sourceFile: './books/prepare-persona.book',
    },
    {
        title: 'Prepare Title',
        pipelineUrl: 'https://promptbook.studio/promptbook/prepare-title.book',
        formfactorName: 'GENERIC',
        parameters: [
            { name: 'book', description: 'The book to prepare the title for', isInput: true, isOutput: false },
            { name: 'title', description: 'Best title for the book', isInput: false, isOutput: true },
        ],
        tasks: [
            {
                taskType: 'PROMPT_TASK',
                ...
                resultingParameterName: 'title',
                expectations: { words: { min: 1, max: 8 }, lines: { min: 1, max: 1 } },
