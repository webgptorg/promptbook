...
[![Socket Badge](https://socket.dev/api/badge/npm/package/@promptbook/execute-javascript)](https://socket.dev/npm/package/@promptbook/execute-javascript)



## 📦 Package `@promptbook/execute-javascript`

- Promptbooks are [divided into several](#-packages) packages, all are published from [single monorepo](https://github.com/webgptorg/promptbook).
- This package `@promptbook/execute-javascript` is one part of the promptbook ecosystem.
