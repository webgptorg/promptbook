...
-   Fixed intermittent loss of Book editor highlighting after navigating away and back without a reload: the Monaco `book` language is now only registered once so remounts keep the grammar/theme setup intact and never skip the syntax decorations.
