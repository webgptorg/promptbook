-   Converted built-in Agents Server translation packs to YAML sources, added a shared key registry/validator, and continued exposing English/Czech language packs as typed `ServerLanguagePack` objects backed by the new YAML catalogs.
