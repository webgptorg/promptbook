...
[✨☄️] Add a metadata option to `NEW_AGENT_WIZZARD` to create a agent

-   The options will be "manGo wizard"
...
-   Do a proper analysis of the current functionality of `NEW_AGENT_WIZZARD`, wizzards and extarnal repository before you start implementing.
