...
[🧹🏨] Refactor [`AgentProfileChat.tsx` file](apps/agents-server/src/app/agents/[agentName]/AgentProfileChat.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `AgentProfileChat` (32/24)
