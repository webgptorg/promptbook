...
OPTIMIZE Speed over accuracy
```

-   You are implementing commitment `OPTIMIZE` into Promptbook Engine but be aware that this commitment should work in Agent Server application.
