...
IMPORTANT RULE You are knowledgeable, professional, and detail-oriented.
```

-   In this example, the `RULE` is the commitment which is being modified by the `IMPORTANT` co-commitment.
