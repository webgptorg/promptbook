...
-   Final commitment indicates that later use of `PERSONA` or other commitments cannot override the initial `PERSONA` defined in the final commitment.
-   For the commitment `FINAL` create its folder in `/src/commitments` and register it in the `/src/commitments/index.ts`
