...
-   When clicking on the chip, show a pop-up with the preview of the document in the opemed pop-up.
...
![alt text](prompts/screenshots/2026-01-0240-client-praha-13-6.png)
![alt text](prompts/screenshots/2026-01-0240-client-praha-13-7.png)

---

[ ]

[✨🤳] Show Document preview after clicking on source chip _(again)_

-   When agent used `KNOWLEDGE` the chip with the source document is shown in the chat.
-   When clicking on the chip, there is shown a pop-up with the preview of the document
-   This is already implemented but the **document preview is not working**.
-   But the preview isn't working now, fix it.
-   Also the download button is not working, fix it.
-   Also remove the technical clutter from the pop-up and design the pop-up nicely, especially the download button.
-   You have already tryed to fix it in the previous task, but it is not working yet, try to analyze deeper what is wrong and fix it.
-   Keep in mind the DRY _(don't repeat yourself)_ principle.

![alt text](prompts/screenshots/2026-01-0240-client-praha-13-10.png)
![alt text](prompts/screenshots/2026-01-0240-client-praha-13-11.png)
![alt text](prompts/screenshots/2026-01-0240-client-praha-13-12.png)
