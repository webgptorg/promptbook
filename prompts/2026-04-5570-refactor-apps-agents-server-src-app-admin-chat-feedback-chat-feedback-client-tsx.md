...
[🧹🧦] Refactor [`ChatFeedbackClient.tsx` file](apps/agents-server/src/app/admin/chat-feedback/ChatFeedbackClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `ChatFeedbackClient` (27/24)
