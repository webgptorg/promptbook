...
[🧹🏜] Refactor [`WalletRecordDialog.tsx` file](apps/agents-server/src/components/WalletRecordDialog/WalletRecordDialog.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `WalletRecordDialog` (57/40)
