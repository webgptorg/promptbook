...
-   Do a:
    ...
    3. Write down the things you found in the analysis and the fixes you implemented into [this file](prompts/2026-03-1570-agents-server-optimize.md)
    4. Write down the things you found but can not fix right now but can be fixed in the future into [this file](prompts/2026-03-1570-agents-server-optimize.md)
...
-   If you can not fix it now but you did some analysis and have a plan how to fix it, write the plan into [this file](prompts/2026-03-1570-agents-server-optimize.md)
