...
[🧹👶] Refactor [`FilesGalleryClient.tsx` file](apps/agents-server/src/app/admin/files/FilesGalleryClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `FilesGalleryClient` (34/24)
