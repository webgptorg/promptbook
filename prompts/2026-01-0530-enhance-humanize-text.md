...
-   Improve the function, try to figure out more cases.
...
-   You are working with the [Utils app](apps/utils) on page http://localhost:4024/humanize
...
-   Remove strings like "【5:1†source】" from the text.
-   Keep in mind the DRY _(don't repeat yourself)_ principle.
