[x] ~$0.1515 9 minutes by OpenAI Codex `gpt-5.4`
...
-   Arrows (the scroll to bottom and opening the my chats sidebar) in the chat should have the same color as buttons "New chat", "Save" - the blue color if the user
