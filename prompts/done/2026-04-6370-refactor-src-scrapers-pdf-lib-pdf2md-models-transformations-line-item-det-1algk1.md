...
[🧹🥗] Refactor [`DetectHeaders.js` file](src/scrapers/pdf/lib/pdf2md/models/transformations/line-item/DetectHeaders.js)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `transform` (30/24)
