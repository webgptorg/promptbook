...
[🧹🥃] Refactor [`getPackagesMetadata.ts` file](scripts/generate-packages/getPackagesMetadata.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `getPackagesMetadata` (36/24)
