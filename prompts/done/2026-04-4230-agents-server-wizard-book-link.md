...
-   When the Wizard is partially filled and the user clicks on the book editor link, the book should be pre-filled with the content from the Wizard, so the user can continue editing the agent in the book editor without losing the progress made in the Wizard.
-   Keep in mind the DRY _(don't repeat yourself)_ principle.
-   Do a proper analysis of the current functionality before you start implementing.
-   You are working with the [Agents Server](apps/agents-server)

![alt text](prompts/screenshots/2026-04-4230-agents-server-wizard-book-link.png)
