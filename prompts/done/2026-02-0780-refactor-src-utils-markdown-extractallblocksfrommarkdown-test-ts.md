[x] ~$0.08 10 minutes by OpenAI Codex `gpt-5.1-codex-mini`

[✨🚲] Refactor [`extractAllBlocksFromMarkdown.test.ts` file](src/utils/markdown/extractAllBlocksFromMarkdown.test.ts)

-   The file is large enough that it is hard to follow.
-   The file contains excessive lines of code (628 lines)
