...
[🧹🚢] Refactor [`useNewAgentWizard.ts` file](apps/agents-server/src/components/NewAgentDialog/useNewAgentWizard.ts)

- The file packs too many responsibilities into one place.
