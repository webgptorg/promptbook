...
-   Open agents can are modified by conversation with them _(that is already implemented)_
-   Closed agents cannot be modified by conversation with them
-   By default, agents are `OPEN` unless specified as `CLOSED`
