...
<- This example is showing broken numbering. Look at the ![screenshot](prompts/screenshots/2026-01-0430-agents-server-lists-in-lists.png).

-   Keep in mind the DRY _(don't repeat yourself)_ principle.
-   You are working with the [Agents Server](apps/agents-server)
-   Add the changes into the [changelog](changelog/_current-preversion.md)

![alt text](prompts/screenshots/2026-01-0430-agents-server-lists-in-lists.png)
