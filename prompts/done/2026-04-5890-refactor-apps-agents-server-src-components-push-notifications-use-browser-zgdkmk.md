...
[🧹🌗] Refactor [`useBrowserPushNotificationsState.ts` file](apps/agents-server/src/components/PushNotifications/useBrowserPushNotificationsState.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useBrowserPushNotificationsState` (39/24)
