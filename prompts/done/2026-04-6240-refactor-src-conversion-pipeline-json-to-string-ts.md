[x] (2 attempts) ~$0.00 40 minutes by GitHub Copilot `gpt-5.4`

[🧹🔻] Refactor [`pipelineJsonToString.ts` file](src/conversion/pipelineJsonToString.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `pipelineJsonToString` (30/24)
