...
[🧹📵] Refactor [`TaskManagerClient.tsx` file](apps/agents-server/src/app/admin/task-manager/TaskManagerClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `TaskManagerClient` (46/40)
