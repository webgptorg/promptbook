...
[🧹🚐] Refactor [`checkSerializableAsJson.ts` file](src/utils/serialization/checkSerializableAsJson.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `checkSerializableAsJson` (26/24)
