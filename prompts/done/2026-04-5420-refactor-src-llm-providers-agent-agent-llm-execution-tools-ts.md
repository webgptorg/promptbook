...
[🧹🐺] Refactor [`AgentLlmExecutionTools.ts` file](src/llm-providers/agent/AgentLlmExecutionTools.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `callChatModelStream` (48/40)
