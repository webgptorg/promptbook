...
[🧹🚏] Refactor [`useChatInputAreaComposer.ts` file](src/book-components/Chat/Chat/useChatInputAreaComposer.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useChatInputAreaComposer` (25/24)
