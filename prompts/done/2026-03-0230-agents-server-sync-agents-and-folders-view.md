[x] ~$0.3761 20 minutes by OpenAI Codex `gpt-5.3-codex`
...
-   Expected behavior:
    ...
    -   New tab / multiple tabs: if a change is made in another tab, returning to the list should refresh within 2 seconds or on focus/visibility change (choose simplest robust approach).
