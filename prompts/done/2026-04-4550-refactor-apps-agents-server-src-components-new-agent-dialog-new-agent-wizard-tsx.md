...
[🧹🆘] Refactor [`NewAgentWizard.tsx` file](apps/agents-server/src/components/NewAgentDialog/NewAgentWizard.tsx)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (26 in single file)
