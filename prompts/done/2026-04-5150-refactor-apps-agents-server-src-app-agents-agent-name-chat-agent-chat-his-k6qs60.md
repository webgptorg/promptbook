...
[🧹↪️] Refactor [`AgentChatHistoryClient.tsx` file](apps/agents-server/src/app/agents/[agentName]/chat/AgentChatHistoryClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `AgentChatHistoryClient` (198/40)
