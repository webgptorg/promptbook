[x] by OpenAI Codex `gpt-5.6-terra` (ChatGPT account) - Implementation ~$0.5899 an hour; Testing 10 minutes
...
created ./packages/wizard/esm/index.es.js, ./packages/wizard/umd/index.umd.js in 19.8s
...
// Note: [🟡] Code for CLI command [agent](src/cli/cli-commands/agent-folder/agentProjectPaths.ts) should never be published outside of `@promptbook/cli`
    at assertBundleFileDoesNotContainCliOnlyMarkerOutsideCli (/Users/hejny/work/promptbook/scripts/generate-packages/assertGeneratedBundlesArePublishSafe.ts:247:11)
    at assertPackageBundleIsPublishSafe (/Users/hejny/work/promptbook/scripts/generate-packages/assertGeneratedBundlesArePublishSafe.ts:86:9)
    at async assertGeneratedBundlesArePublishSafe (/Users/hejny/work/promptbook/scripts/generate-packages/assertGeneratedBundlesArePublishSafe.ts:63:9)
    at async generatePackages (/Users/hejny/work/promptbook/scripts/generate-packages/generate-packages.ts:174:5)
```