[x] ~$0.00 26 minutes by GitHub Copilot `gpt-5.4`

[🧹☝️] Refactor [`BookEditorWrapper.tsx` file](apps/agents-server/src/app/agents/[agentName]/book/BookEditorWrapper.tsx)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (24 in single file)
