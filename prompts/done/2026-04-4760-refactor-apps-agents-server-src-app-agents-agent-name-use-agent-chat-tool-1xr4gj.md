[x] ~$0.1920 8 minutes by OpenAI Codex `gpt-5.4`

[🧹😙] Refactor [`useAgentChatToolInteractions.ts` file](apps/agents-server/src/app/agents/[agentName]/useAgentChatToolInteractions.ts)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (27 in single file)
