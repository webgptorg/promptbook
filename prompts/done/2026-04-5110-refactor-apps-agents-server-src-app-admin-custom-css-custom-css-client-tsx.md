...
[🧹🫓] Refactor [`CustomCssClient.tsx` file](apps/agents-server/src/app/admin/custom-css/CustomCssClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `CustomCssClient` (70/40)
