...
[🧹🧎] Refactor [`TeamToolCallModalContent.tsx` file](src/book-components/Chat/Chat/TeamToolCallModalContent.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `TeamToolCallModalContent` (33/24)
