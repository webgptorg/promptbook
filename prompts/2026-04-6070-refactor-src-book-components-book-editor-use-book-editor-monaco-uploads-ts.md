...
[🧹↕️] Refactor [`useBookEditorMonacoUploads.ts` file](src/book-components/BookEditor/useBookEditorMonacoUploads.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useBookEditorMonacoUploads` (31/24)
