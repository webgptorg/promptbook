...
[🧹🔖] Refactor [`route.ts` file](apps/agents-server/src/app/agents/[agentName]/api/calendar-events/route.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `executeCalendarOperation` (25/24)
