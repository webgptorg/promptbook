...
[🧹😩] Refactor [`useCustomCssClientState.ts` file](apps/agents-server/src/app/admin/custom-css/useCustomCssClientState.ts)
...
- The file contains too many functions (22/20)
