...
[✨⬆️] Refactor [`renderToolCallDetails.tsx` file](src/book-components/Chat/Chat/renderToolCallDetails.tsx)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (41 in single file)
