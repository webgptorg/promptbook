...
[🧹⚇] Refactor [`useServersRegistryState.ts` file](apps/agents-server/src/app/admin/servers/useServersRegistryState.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useServersRegistryState` (27/24)
