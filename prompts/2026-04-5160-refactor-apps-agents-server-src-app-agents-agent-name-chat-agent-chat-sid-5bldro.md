...
[🧹𓀀] Refactor [`AgentChatSidebar.tsx` file](apps/agents-server/src/app/agents/[agentName]/chat/AgentChatSidebar.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `AgentChatSidebar` (70/40)
