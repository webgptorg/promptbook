...
[🧹☢️] Refactor [`createPipelineCollectionFromDirectory.ts` file](src/collection/pipeline-collection/constructors/createPipelineCollectionFromDirectory.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `createPipelineCollectionFromDirectory` (42/40)
