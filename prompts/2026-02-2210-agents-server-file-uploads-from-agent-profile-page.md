[x] ~$0.2686 13 minutes by OpenAI Codex `gpt-5.1-codex-mini`

[✨💭] Allow uploading files from the agent profile page.

-   In the agent chat page of the agent, you can upload files if this feature is allowed on the server.
-   But the same feature isn't available from the agent profile page. Implement it.
