...
[🧹🧻] Refactor [`BrowserPushNotificationsProvider.tsx` file](apps/agents-server/src/components/PushNotifications/BrowserPushNotificationsProvider.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `BrowserPushNotificationsProvider` (59/40)
