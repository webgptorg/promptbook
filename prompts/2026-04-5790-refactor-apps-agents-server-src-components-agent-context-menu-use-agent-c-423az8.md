...
[🧹🖕] Refactor [`useAgentContextMenuItems.ts` file](apps/agents-server/src/components/AgentContextMenu/useAgentContextMenuItems.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useAgentContextMenuActions` (25/24)
