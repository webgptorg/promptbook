...
[🧹©️] Refactor [`renderRunBrowserToolCallDetails.tsx` file](src/book-components/Chat/Chat/renderRunBrowserToolCallDetails.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `renderRunBrowserToolCallDetails` (56/40)
