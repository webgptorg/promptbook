...
[🧹🎋] Refactor [`useBookEditorWrapper.tsx` file](apps/agents-server/src/app/agents/[agentName]/book/useBookEditorWrapper.tsx)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (22 in single file)
