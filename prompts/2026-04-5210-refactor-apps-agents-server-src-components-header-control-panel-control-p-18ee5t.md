...
[🧹🚳] Refactor [`ControlPanel.tsx` file](apps/agents-server/src/components/Header/ControlPanel/ControlPanel.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `ControlPanelContent` (61/40)
