...
-   If there is already an existing “post-round / post-write” hook or pipeline step, integrate there; otherwise add a minimal, well-named function/module.
-   Add automated coverage (unit test and/or simple integration test) that simulates a changed file with CRLF and verifies it is stored as LF.
