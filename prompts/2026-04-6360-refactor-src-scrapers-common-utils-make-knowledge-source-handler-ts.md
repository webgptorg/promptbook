...
[🧹🏅] Refactor [`makeKnowledgeSourceHandler.ts` file](src/scrapers/_common/utils/makeKnowledgeSourceHandler.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `makeKnowledgeSourceHandler` (36/24)
