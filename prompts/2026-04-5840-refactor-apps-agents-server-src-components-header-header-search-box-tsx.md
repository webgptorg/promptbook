...
[🧹😭] Refactor [`HeaderSearchBox.tsx` file](apps/agents-server/src/components/Header/HeaderSearchBox.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `HeaderSearchBox` (32/24)
