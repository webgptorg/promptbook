...
-   Use the OpenaAI realtime API to create the miniapp
-   Miniapp will be encapsulated in a React component `<OpenAIRealtimeAgent />` that can be used in any Next.js page
