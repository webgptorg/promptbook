...
-   In dark mode there are some ugly and unfinished places:
    ...
    -   Book editor white outline
        -   ![alt text](prompts/screenshots/2026-04-6670-agents-server-dark-mode-17.png)
        -   ![alt text](prompts/screenshots/2026-04-6670-agents-server-dark-mode-18.png)
        -   ![alt text](prompts/screenshots/2026-04-6670-agents-server-dark-mode-19.png)
-   Keep in mind the DRY _(don't repeat yourself)_ principle.
-   Do a proper analysis of the current functionality before you start implementing
-   You are working with the [Agents Server](apps/agents-server)
