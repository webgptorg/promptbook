...
TEACHER http://localhost:4440/agents/GMw67JN8TXxN7y
```

-   You are implementing commitment `TEACHER` into Promptbook Engine but be aware that this commitment should work in Agent Server application.
