...
[🧹🧟] Refactor [`useChatAutoScroll.ts` file](src/book-components/Chat/hooks/useChatAutoScroll.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `useChatAutoScroll` (30/24)
