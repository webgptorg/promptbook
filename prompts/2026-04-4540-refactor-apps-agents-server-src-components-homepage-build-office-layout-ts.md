...
[✨🖕] Refactor [`buildOfficeLayout.ts` file](apps/agents-server/src/components/Homepage/buildOfficeLayout.ts)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (37 in single file)
