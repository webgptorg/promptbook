...
[🧹👾] Refactor [`syncVercelDomainsMain.ts` file](apps/agents-server/scripts/syncVercelDomainsMain.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `syncVercelDomainsMain` (26/24)
