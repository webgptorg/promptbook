...
[🧹🌙] Refactor [`HeaderMobileDrawer.tsx` file](apps/agents-server/src/components/Header/HeaderMobileDrawer.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `HeaderMobileDrawer` (32/24)
