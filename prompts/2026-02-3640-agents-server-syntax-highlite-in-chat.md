[x] ~$0.2641 26 minutes by OpenAI Codex `gpt-5.3-codex`

[✨𓀖] In the chat use the monaco editor for the code snippets
...
-   Be aware that there can be multiple code snippets with multiple languages. Isolate these Monaco editors to not interfere with one syntax highlighting with other syntax highlighting.
