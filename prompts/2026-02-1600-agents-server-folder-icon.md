...
[✨🧘] Do not use single letters as an icon for a folder, but show the proper folder icon.

-   You are working with the [Agents Server](apps/agents-server)

![alt text](prompts/screenshots/2026-02-1600-agents-server-folder-icon.png)
...
1. The navigation hierarchy
    ...
    - arrow ">" and Agents or picked agent name (organized in folders) **<- HERE CAN BE THE FOLDER ICON**
