...
[🧹🥸] Refactor [`ImagesGalleryClient.tsx` file](apps/agents-server/src/app/admin/images/ImagesGalleryClient.tsx)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `ImagesGalleryClient` (38/24)
