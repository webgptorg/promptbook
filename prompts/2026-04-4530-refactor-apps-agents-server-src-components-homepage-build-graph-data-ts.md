...
[✨🧏] Refactor [`buildGraphData.ts` file](apps/agents-server/src/components/Homepage/buildGraphData.ts)

- The file is dense enough that it is hard to follow.
- The file defines too many responsibilities (30 in single file)
