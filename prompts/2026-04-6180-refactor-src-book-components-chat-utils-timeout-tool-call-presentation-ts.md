...
[🧹✋] Refactor [`timeoutToolCallPresentation.ts` file](src/book-components/Chat/utils/timeoutToolCallPresentation.ts)

- The file contains logic that is too complex to follow comfortably.
- The file contains overly complex logic in `resolveTimeoutToolCallPresentation` (26/24)
