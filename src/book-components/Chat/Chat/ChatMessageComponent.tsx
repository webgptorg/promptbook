 ...
 */
export function ChatMessageComponent(props: ChatMessageComponentProps) {
    const { message, participants, onMessage } = props;
    ...
    const shouldShowButtons = message.isLastMessage && buttons.length > 0 && onMessage;
                ...
                {message.isComplete && (
                    ...
                    >
                        {expandedMessageId === message.id ? (
                            [1, 2, 3, 4, 5].map((star) => (
                                <span
                                    ...
                                    style={{
                                        ...
                                        fontSize: '20px',
                                        color:
                                            star <= (hoveredRating || messageRatings.get(message.id) || 0)
                                                ? '#FFD700'
                                                : mode === 'LIGHT'
                                                ? '#ccc'
                                                : '#555',
                            ...
                            <span
                                onClick={() => handleRating(message, messageRatings.get(message.id) || 1)}
                                style={{
                                    cursor: 'pointer',
                                    fontSize: '20px',
