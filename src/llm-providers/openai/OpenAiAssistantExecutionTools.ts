...
// Note: Vector store helpers live in OpenAiVectorStoreExecutionTools
 ...
 * @deprecated Use `OpenAiAgentKitExecutionTools` instead which uses the new OpenAI AgentKit
 */
export class OpenAiAssistantExecutionTools extends OpenAiVectorStoreExecutionTools implements LlmExecutionTools {
    /* <- TODO: [🍚] `, Destroyable` */
