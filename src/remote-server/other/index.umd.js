...
((global, factory) => {
	typeof exports === "object" && typeof module !== "undefined"
		...
		: typeof define === "function" && define.amd
			...
			: ((global =
				...
				factory(
					(global["promptbook-remote-server"] = {}),
					global.colors,
					global.http,
					global.socket_io,
					global.spaceTrim,
  ...
  ***************************************************************************** */
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var EnvironmentMismatchError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var NotYetImplementedError = /** @class */ ((_super) => {
		...
		function getErrorReportUrl(error) {
			var report = {
				...
				body: spaceTrim__default["default"]((block) =>
					"\n\n\n            `"
						.concat(error.name || "Error", "` has occurred in the [")
						.concat(NAME, "], please look into it @")
						.concat(ADMIN_GITHUB_NAME, ".\n\n            ```\n            ")
						.concat(
							block(error.message || "(no error message)"),
							"\n            ```\n\n\n            ## More info:\n\n            - **Promptbook engine version:** ",
						)
						.concat(
							PROMPTBOOK_ENGINE_VERSION,
							"\n            - **Book language version:** ",
						)
						.concat(BOOK_LANGUAGE_VERSION, "\n            - **Time:** ")
						.concat(
			...
			var reportUrl = new URL(
				"https://github.com/webgptorg/promptbook/issues/new",
			);
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var UnexpectedError = /** @class */ ((_super) => {
		...
		var $Register = /** @class */ (() => {
			function $Register(registerName) {
				...
				var storageName = "_promptbook_".concat(
					normalizeTo_snake_case(registerName),
				);
				...
				if (globalScope[storageName] === undefined) {
					...
					throw new UnexpectedError(
						"Expected (global) "
							.concat(storageName, " to be an array, but got ")
							.concat(typeof globalScope[storageName]),
					);
				}
			...
			$Register.prototype.register = function (registered) {
				var packageName = registered.packageName,
					className = registered.className;
				var existingRegistrationIndex = this.storage.findIndex(
					(item) =>
				...
				return {
					...
					destroy: function () {
						throw new NotYetImplementedError(
							"Registration to ".concat(
								this.registerName,
								" is permanent in this version of Promptbook",
							),
						);
					},
				};
				...
				return __generator(this, (_g) => {
					switch (_g.label) {
						case 0:
							if (!$isRunningInNode()) {
								throw new EnvironmentMismatchError(
									"Function `$getScrapersForNode` works only in Node.js environment",
								);
							}
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var PipelineExecutionError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var AbstractFormatError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var CsvFormatError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var CollectionError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var KnowledgeScrapeError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var LimitReachedError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var MissingToolsError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var PipelineLogicError = /** @class */ ((_super) => {
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var PipelineUrlError = /** @class */ ((_super) => {
    ...
    */
		 ...
		 * @private for internal usage
		 */
		var ALL_ERRORS = __assign(
			__assign({}, PROMPTBOOK_ERRORS),
			...
			if (!Object.keys(ALL_ERRORS).includes(name)) {
				console.error(
					spaceTrim__default["default"]((block) =>
						'\n          \n                    Cannot serialize error with name "'
							.concat(name, '"\n\n                    ')
							.concat(
								block(stack || message),
								"\n                \n                ",
...
at step (C:\\Users\\me\\work\\webgpt\\promptbook-studio\\node_modules\\node_modules\\tslib\\tslib.es6.js:102:23)
				...
				return __generator(this, (_c) => {
					switch (_c.label) {
						case 0:
							...
							return [
								4 /*yield*/,
								isExecutable(regPath, $provideFilesystemForNode()),
							];
						case 1:
						...
						case 2:
							return [
								4 /*yield*/,
								isExecutable(altPath, $provideFilesystemForNode()),
							];
						case 3:
							if (_c.sent()) {
						...
						case 4:
							return [
								4 /*yield*/,
								exec(
									"mdfind 'kMDItemDisplayName == \"".concat(
										macOsName,
		...
		function locateAppOnWindows(_a) {
			var appName = _a.appName,
				windowsSuffix = _a.windowsSuffix;
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, (_c) => {
					switch (_c.label) {
						...
						case 2:
							...
							return [
								4 /*yield*/,
								isExecutable(path$1, $provideFilesystemForNode()),
							];
						case 3:
							if (_c.sent()) {
						...
						case 8:
							throw new Error(
								"Can not locate app ".concat(appName, " on Windows."),
							);
						case 9:
							error_1 = _c.sent();
							if (!(error_1 instanceof Error)) {
		...
		function locateApp(options) {
			...
			var appName = options.appName,
				linuxWhich = options.linuxWhich,
				windowsSuffix = options.windowsSuffix,
				macOsName = options.macOsName;
			if (process.platform === "win32") {
				if (windowsSuffix) {
					return locateAppOnWindows({
						appName: appName,
						windowsSuffix: windowsSuffix,
					});
				} else {
				...
				return __generator(this, (_e) => {
					switch (_e.label) {
						...
						case 2:
							return [
								2 /*return*/,
								((_d.libreOfficePath = _e.sent() || undefined), _d),
							];
					}
				});
			});
		 ...
		 * @public exported from `@promptbook/core`
		 */
		var MultipleLlmExecutionTools = /** @class */ (() => {
			/**
			...
			Object.defineProperty(MultipleLlmExecutionTools.prototype, "title", {
				get: () => "Multiple LLM Providers",
				enumerable: false,
				configurable: true,
			});
			Object.defineProperty(
				MultipleLlmExecutionTools.prototype,
				"description",
				{
					get: function () {
				...
				return __awaiter(this, void 0, void 0, function () {
					...
					return __generator(this, function (_d) {
						switch (_d.label) {
							...
							case 3:
								models = _d.sent();
								availableModels.push.apply(
									availableModels,
									__spreadArray([], __read(models), false),
								);
								_d.label = 4;
							case 4:
								_b = _a.next();
			 ...
			 */
			MultipleLlmExecutionTools.prototype.callCompletionModel = function (
				prompt,
			) {
				return this.callCommonModel(prompt);
			};
			 ...
			 */
			MultipleLlmExecutionTools.prototype.callEmbeddingModel = function (
				prompt,
			) {
				return this.callCommonModel(prompt);
			};
					...
					return __generator(this, function (_e) {
						switch (_e.label) {
							...
							case 6:
								...
								return [
									4 /*yield*/,
									llmExecutionTools.callCompletionModel(prompt),
								];
							case 7:
								return [2 /*return*/, _e.sent()];
							case 8:
								...
								return [
									4 /*yield*/,
									llmExecutionTools.callEmbeddingModel(prompt),
								];
							case 9:
								return [2 /*return*/, _e.sent()];
							case 10:
							...
							case 12:
								...
								if (
									...
									error_1 instanceof UnexpectedError
								) {
									throw error_1;
								}
								errors.push(error_1);
		...
		function joinLlmExecutionTools() {
          ...
          */
			...
			return new (MultipleLlmExecutionTools.bind.apply(
				MultipleLlmExecutionTools,
				__spreadArray([void 0], __read(llmExecutionTools), false),
			))();
		}
		/**
		...
		function $registeredLlmToolsMessage() {
			 ...
			 */
			var all = [];
			var _loop_1 = (title, packageName, className, envVariables) => {
				if (
					all.some(
						(item) =>
							item.packageName === packageName && item.className === className,
			...
			try {
				for (
					var _c = __values($llmToolsMetadataRegister.list()), _d = _c.next();
					!_d.done;
					_d = _c.next()
				) {
					var _e = _d.value,
						title = _e.title,
						packageName = _e.packageName,
						className = _e.className,
						envVariables = _e.envVariables;
			...
			var _loop_2 = (packageName, className) => {
				if (
					all.some(
						(item) =>
							item.packageName === packageName && item.className === className,
			...
			try {
				for (
					var _f = __values($llmToolsRegister.list()), _g = _f.next();
					!_g.done;
					_g = _f.next()
				) {
					var _h = _g.value,
						packageName = _h.packageName,
			...
			var metadata = all.map((metadata) => {
				...
				var isInstalled = $llmToolsRegister.list().find((_a) => {
					var packageName = _a.packageName,
						className = _a.className;
					return (
						metadata.packageName === packageName &&
				...
				var isFullyConfigured =
					((_a = metadata.envVariables) === null || _a === void 0
						? void 0
						: _a.every(
								(envVariableName) => env[envVariableName] !== undefined,
							)) || false;
				var isPartiallyConfigured =
					((_b = metadata.envVariables) === null || _b === void 0
						? void 0
						: _b.some(
								(envVariableName) => env[envVariableName] !== undefined,
							)) || false;
				...
				return __assign(__assign({}, metadata), {
					isMetadataAviailable: isMetadataAviailable,
							...
							Object.keys(env)
								.filter((envVariableName) =>
									metadata.some((_a) => {
										...
										return envVariables === null || envVariables === void 0
											? void 0
											: envVariables.includes(envVariableName);
									}),
								)
								.map((envVariableName) => "- `".concat(envVariableName, "`"))
								.join("\n"),
						),
							...
							metadata
								.map((_a, i) => {
									var title = _a.title,
										...
										className = _a.className,
										envVariables = _a.envVariables,
										isMetadataAviailable = _a.isMetadataAviailable,
										isInstalled = _a.isInstalled,
										isFullyConfigured = _a.isFullyConfigured,
										isPartiallyConfigured = _a.isPartiallyConfigured;
									var morePieces = [];
									if (just(false));
									else if (!isMetadataAviailable && !isInstalled) {
										// TODO: [�][�] Maybe do allow to do auto-install if package not registered and not found
										morePieces.push(
											"Not installed and no metadata, looks like a unexpected behavior",
										);
									} else if (isMetadataAviailable && !isInstalled) {
										// TODO: [�][�]
										...
										morePieces.push(
											"No metadata but installed, looks like a unexpected behavior",
										);
									} else if (isMetadataAviailable && isInstalled) {
										morePieces.push("Installed");
									} else {
										morePieces.push(
											"unknown state, looks like a unexpected behavior",
										);
									} /* not else */
									if (isFullyConfigured) {
										...
										morePieces.push(
											"Partially confugured, missing ".concat(
												envVariables === null || envVariables === void 0
													? void 0
													: envVariables
															.filter(
																(envVariable) => env[envVariable] === undefined,
															)
															.join(" + "),
											),
										);
										...
										if (envVariables !== null) {
											morePieces.push(
												"Not configured, to configure set env ".concat(
													envVariables === null || envVariables === void 0
														? void 0
														: envVariables.join(" + "),
												),
									...
									if ($isRunningInNode) {
										if (isInstalled && isFullyConfigured) {
											providerMessage =
												colors__default["default"].green(providerMessage);
										} else if (isInstalled && isPartiallyConfigured) {
											providerMessage =
												colors__default["default"].yellow(providerMessage);
										} else {
											providerMessage =
												colors__default["default"].gray(providerMessage);
										}
									}
		...
		function createLlmToolsFromConfiguration(configuration, options) {
			...
			var _a = options.isVerbose,
				isVerbose = _a === void 0 ? DEFAULT_IS_VERBOSE : _a,
				userId = options.userId;
			var llmTools = configuration.map((llmConfiguration) => {
				var registeredItem = $llmToolsRegister.list().find((_a) => {
					var packageName = _a.packageName,
						className = _a.className;
					return (
				...
				if (registeredItem === undefined) {
					throw new Error(
						spaceTrim__default["default"]((block) =>
							"\n                        There is no constructor for LLM provider `"
								.concat(llmConfiguration.className, "` from `")
								.concat(
				...
				return registeredItem(
					__assign(
						{ isVerbose: isVerbose, userId: userId },
						llmConfiguration.options,
					),
				);
			});
			return joinLlmExecutionTools.apply(
				void 0,
				__spreadArray([], __read(llmTools), false),
			);
		}
		/**
		...
		var PipelineCollection = [
			{
				...
				parameters: [
					...
					{
						name: "knowledgePieces",
						description: "The knowledge JSON object",
						isInput: false,
						isOutput: true,
					},
				],
				...
				sourceFile: "./books/prepare-knowledge-from-markdown.book.md",
			},
			{
				...
				sourceFile: "./books/prepare-knowledge-keywords.book.md",
			},
			{
				title: "Prepare Knowledge-piece Title",
				pipelineUrl:
				...
				sourceFile: "./books/prepare-knowledge-title.book.md",
			},
			{
				title: "Prepare Persona",
				pipelineUrl:
					"https://promptbook.studio/promptbook/prepare-persona.book.md",
				formfactorName: "GENERIC",
				parameters: [
					{
			...
			},
			{
				title: "Prepare Title",
				pipelineUrl:
					"https://promptbook.studio/promptbook/prepare-title.book.md",
				formfactorName: "GENERIC",
				parameters: [
					{
						name: "book",
						description: "The book to prepare the title for",
						isInput: true,
						isOutput: false,
					},
					{
						name: "title",
						description: "Best title for the book",
						isInput: false,
						isOutput: true,
					},
				],
		...
		function pipelineJsonToString(pipelineJson) {
			...
			var title = pipelineJson.title,
				pipelineUrl = pipelineJson.pipelineUrl,
				bookVersion = pipelineJson.bookVersion,
				description = pipelineJson.description,
				parameters = pipelineJson.parameters,
				tasks = pipelineJson.tasks;
			...
			try {
				for (
					...
					commands.push(
						"INPUT PARAMETER ".concat(taskParameterJsonToString(parameter)),
					);
				}
			} catch (e_1_1) {
				e_1 = { error: e_1_1 };
			...
			try {
				for (
					...
					commands.push(
						"OUTPUT PARAMETER ".concat(taskParameterJsonToString(parameter)),
					);
				}
			} catch (e_2_1) {
				e_2 = { error: e_2_1 };
			...
			pipelineString += "\n\n";
			pipelineString += commands
				.map((command) => "- ".concat(command))
				.join("\n");
			try {
				for (
					var tasks_1 = __values(tasks), tasks_1_1 = tasks_1.next();
					!tasks_1_1.done;
					tasks_1_1 = tasks_1.next()
				) {
					var task = tasks_1_1.value;
					var /* Note: Not using:> name, */
						title_1 = task.title,
						description_1 = task.description,
						/* Note: dependentParameterNames, */
						jokers = task.jokerParameterNames,
						taskType = task.taskType,
						content = task.content,
						postprocessing = task.postprocessingFunctionNames,
						expectations = task.expectations,
						format = task.format,
						resultingParameterName = task.resultingParameterName;
					pipelineString += "\n\n";
					...
					if (taskType === "PROMPT_TASK") {
						...
						var _l = modelRequirements || {},
							modelName = _l.modelName,
							modelVariant = _l.modelVariant;
						// Note: Do nothing, it is default
						// commands.push(`PROMPT`);
						if (modelVariant) {
							commands_1.push(
								"MODEL VARIANT ".concat(capitalize(modelVariant)),
							);
						}
						if (modelName) {
					...
					if (jokers) {
						try {
							for (
								var jokers_1 = ((e_4 = void 0), __values(jokers)),
									jokers_1_1 = jokers_1.next();
								!jokers_1_1.done;
								jokers_1_1 = jokers_1.next()
							) {
							...
							try {
								if (jokers_1_1 && !jokers_1_1.done && (_d = jokers_1.return))
									_d.call(jokers_1);
							} finally {
					...
					if (postprocessing) {
						try {
							for (
								var postprocessing_1 =
										((e_5 = void 0), __values(postprocessing)),
									postprocessing_1_1 = postprocessing_1.next();
								!postprocessing_1_1.done;
								postprocessing_1_1 = postprocessing_1.next()
							) {
								var postprocessingFunctionName = postprocessing_1_1.value;
								commands_1.push(
									"POSTPROCESSING `".concat(postprocessingFunctionName, "`"),
								);
							}
						} catch (e_5_1) {
							e_5 = { error: e_5_1 };
							...
							try {
								if (
									postprocessing_1_1 &&
									!postprocessing_1_1.done &&
									(_e = postprocessing_1.return)
								)
									_e.call(postprocessing_1);
							} finally {
					...
					if (expectations) {
						try {
							for (
								var _m =
										((e_6 = void 0), __values(Object.entries(expectations))),
									_o = _m.next();
								!_o.done;
								_o = _m.next()
							) {
								...
								if (min === max) {
									commands_1.push(
										"EXPECT EXACTLY "
											.concat(min, " ")
											.concat(capitalize(unit + (min > 1 ? "s" : ""))),
									);
								} else {
									if (min !== undefined) {
										commands_1.push(
									...
									if (max !== undefined) {
										commands_1.push(
											"EXPECT MAX "
												.concat(max, " ")
												.concat(capitalize(unit + (max > 1 ? "s" : ""))),
										);
									}
								}
							}
				...
				try {
					if (tasks_1_1 && !tasks_1_1.done && (_c = tasks_1.return))
						_c.call(tasks_1);
				} finally {
					if (e_3) throw e_3.error;
				}
		...
		function taskParameterJsonToString(taskParameterJson) {
			var name = taskParameterJson.name,
				description = taskParameterJson.description;
		...
		function orderJson(options) {
			var value = options.value,
				order = options.order;
			var orderedValue = __assign(
				__assign(
					{},
					order === undefined
						? {}
						: Object.fromEntries(order.map((key) => [key, undefined])),
				),
				value,
			);
			return orderedValue;
		...
		function $deepFreeze(objectValue) {
			...
			try {
				for (
					var propertyNames_1 = __values(propertyNames),
						propertyNames_1_1 = propertyNames_1.next();
					!propertyNames_1_1.done;
					propertyNames_1_1 = propertyNames_1.next()
				) {
				...
				try {
					if (
						propertyNames_1_1 &&
						!propertyNames_1_1.done &&
						(_a = propertyNames_1.return)
					)
						_a.call(propertyNames_1);
				} finally {
					if (e_1) throw e_1.error;
				}
			}
		...
		function checkSerializableAsJson(options) {
			...
			if (value === undefined) {
				...
				if (value instanceof Date) {
					...
					try {
						for (
							var _b = __values(Object.entries(value)), _c = _b.next();
							!_c.done;
							_c = _b.next()
						) {
      ...
      */
		...
		function validatePipeline_InnerFunction(pipeline) {
			...
			if (
				pipeline.pipelineUrl !== undefined &&
				!isValidPipelineUrl(pipeline.pipelineUrl)
			) {
				// <- Note: [🚲]
				throw new PipelineLogicError(
					spaceTrim.spaceTrim((block) =>
						'\n                    Invalid promptbook URL "'
							.concat(pipeline.pipelineUrl, '"\n\n                    ')
							.concat(block(pipelineIdentification), "\n                "),
					),
				);
			}
			if (
				pipeline.bookVersion !== undefined &&
				!isValidPromptbookVersion(pipeline.bookVersion)
			) {
				// <- Note: [🚲]
				throw new PipelineLogicError(
					spaceTrim.spaceTrim((block) =>
						'\n                    Invalid Promptbook Version "'
							.concat(pipeline.bookVersion, '"\n\n                    ')
							.concat(block(pipelineIdentification), "\n                "),
					),
				);
			}
			...
			if (!Array.isArray(pipeline.parameters)) {
				...
				throw new ParseError(
					spaceTrim.spaceTrim((block) =>
						"\n                    Pipeline is valid JSON but with wrong structure\n\n                    `PipelineJson.parameters` expected to be an array, but got "
							.concat(typeof pipeline.parameters, "\n\n                    ")
							.concat(block(pipelineIdentification), "\n                "),
					),
				);
			}
			...
			if (!Array.isArray(pipeline.tasks)) {
				...
				throw new ParseError(
					spaceTrim.spaceTrim((block) =>
						"\n                    Pipeline is valid JSON but with wrong structure\n\n                    `PipelineJson.tasks` expected to be an array, but got "
							.concat(typeof pipeline.tasks, "\n\n                    ")
							.concat(block(pipelineIdentification), "\n                "),
					),
				);
			}
			var _loop_1 = (parameter) => {
					...
					throw new PipelineLogicError(
						spaceTrim.spaceTrim((block) =>
							"\n\n                        Parameter `{"
								.concat(
									parameter.name,
									"}` can not be both input and output\n\n                        ",
								)
								.concat(
				...
				if (
					!parameter.isInput &&
					!parameter.isOutput &&
					!pipeline.tasks.some((task) =>
						task.dependentParameterNames.includes(parameter.name),
					)
				) {
					throw new PipelineLogicError(
						spaceTrim.spaceTrim((block) =>
							"\n                        Parameter `{"
								.concat(
									parameter.name,
									"}` is created but not used\n\n                        You can declare {",
								)
								.concat(
									parameter.name,
									"} as output parameter by adding in the header:\n                        - OUTPUT PARAMETER `{",
								)
					...
					throw new PipelineLogicError(
						spaceTrim.spaceTrim((block) =>
							"\n                        Parameter `{"
								.concat(
									parameter.name,
									"}` is declared but not defined\n\n                        You can do one of these:\n                        1) Remove declaration of `{",
								)
								.concat(
									parameter.name,
									"}`\n                        2) Add task that results in `-> {",
								)
								.concat(parameter.name, "}`\n\n                        ")
								.concat(
									block(pipelineIdentification),
          ...
          */
				...
				for (
					var _d = __values(pipeline.parameters), _e = _d.next();
					!_e.done;
					_e = _d.next()
				) {
			...
			var _loop_2 = (task) => {
					...
					throw new PipelineLogicError(
						spaceTrim.spaceTrim((block) =>
							"\n                        Parameter name {"
								.concat(
									task.resultingParameterName,
									"} is reserved, please use different name\n\n                        ",
								)
								.concat(
									block(pipelineIdentification),
									"\n                    ",
				...
				if (task.jokerParameterNames && task.jokerParameterNames.length > 0) {
					...
					try {
						for (
							var _k = ((e_4 = void 0), __values(task.jokerParameterNames)),
								_l = _k.next();
							!_l.done;
							_l = _k.next()
						) {
				...
				if (task.expectations) {
					var _loop_5 = (unit, min, max) => {
						if (min !== undefined && max !== undefined && min > max) {
							throw new PipelineLogicError(
								spaceTrim.spaceTrim((block) =>
									"\n                                Min expectation (="
										.concat(min, ") of ")
										.concat(unit, " is higher than max expectation (=")
										.concat(max, ")\n\n                                ")
										.concat(
											block(pipelineIdentification),
											"\n                            ",
					...
					try {
						for (
							var _m =
									((e_5 = void 0), __values(Object.entries(task.expectations))),
								_o = _m.next();
							!_o.done;
							_o = _m.next()
						) {
			...
			try {
				...
				for (
					var _f = __values(pipeline.tasks), _g = _f.next();
					!_g.done;
					_g = _f.next()
				) {
					var task = _g.value;
			...
			try {
				...
				for (
					var RESERVED_PARAMETER_NAMES_1 = __values(RESERVED_PARAMETER_NAMES),
						RESERVED_PARAMETER_NAMES_1_1 = RESERVED_PARAMETER_NAMES_1.next();
					!RESERVED_PARAMETER_NAMES_1_1.done;
					RESERVED_PARAMETER_NAMES_1_1 = RESERVED_PARAMETER_NAMES_1.next()
				) {
					var reservedParameterName = RESERVED_PARAMETER_NAMES_1_1.value;
					resovedParameters = __spreadArray(
						__spreadArray([], __read(resovedParameters), false),
				...
				try {
					if (
						...
						!RESERVED_PARAMETER_NAMES_1_1.done &&
						(_c = RESERVED_PARAMETER_NAMES_1.return)
					)
						_c.call(RESERVED_PARAMETER_NAMES_1);
				} finally {
					if (e_3) throw e_3.error;
				}
			}
			...
			var _loop_3 = () => {
				...
				var currentlyResovedTasks = unresovedTasks.filter((task) =>
					task.dependentParameterNames.every((name) =>
						resovedParameters.includes(name),
					),
				);
							...
							"\n\n                        Can not resolve some parameters:\n                        Either you are using a parameter that is not defined, or there are some circular dependencies.\n\n                        "
										...
										unresovedTasks
											.map((_a) => {
												var resultingParameterName = _a.resultingParameterName,
													dependentParameterNames = _a.dependentParameterNames;
												return "- Parameter `{"
													.concat(
													...
													.concat(
														dependentParameterNames
															.map((dependentParameterName) =>
																"`{".concat(dependentParameterName, "}`"),
															)
															.join(" and "),
													);
											})
								...
								.concat(
									block(
										resovedParameters
											.filter(
												(name) => !RESERVED_PARAMETER_NAMES.includes(name),
											)
											.map((name) => "- Parameter `{".concat(name, "}`"))
											.join("\n"),
									),
				...
				unresovedTasks = unresovedTasks.filter(
					(task) => !currentlyResovedTasks.includes(task),
				);
			};
		...
		function unpreparePipeline(pipeline) {
			var personas = pipeline.personas,
				knowledgeSources = pipeline.knowledgeSources,
				tasks = pipeline.tasks;
			personas = personas.map((persona) =>
				__assign(__assign({}, persona), {
					modelRequirements: undefined,
					preparationIds: undefined,
				}),
			);
			knowledgeSources = knowledgeSources.map((knowledgeSource) =>
				__assign(__assign({}, knowledgeSource), { preparationIds: undefined }),
			);
			tasks = tasks.map((task) => {
				...
				dependentParameterNames = dependentParameterNames.filter(
					(dependentParameterName) =>
						!parameterNames.has(dependentParameterName),
				);
				var taskUnprepared = __assign(__assign({}, task), {
		 ...
		 */
		var SimplePipelineCollection = /** @class */ (() => {
			/**
			...
			function SimplePipelineCollection() {
				...
				try {
					for (
						var pipelines_1 = __values(pipelines),
							pipelines_1_1 = pipelines_1.next();
						!pipelines_1_1.done;
						pipelines_1_1 = pipelines_1.next()
					) {
						...
						spaceTrim.spaceTrim((block) =>
							'\n                        Pipeline with url "'
								...
								.concat(
									block(
										this.listPipelines()
											.map((pipelineUrl) => "- ".concat(pipelineUrl))
											.join("\n"),
									),
									"\n\n                    ",
								),
			 ...
			 */
			SimplePipelineCollection.prototype.isResponsibleForPrompt = (prompt) =>
				true;
		...
		function createCollectionFromJson() {
			...
			return new (SimplePipelineCollection.bind.apply(
				SimplePipelineCollection,
				__spreadArray([void 0], __read(promptbooks), false),
			))();
		}
		...
		function assertsExecutionSuccessful(executionResult) {
			var isSuccessful = executionResult.isSuccessful,
		...
		function isPipelinePrepared(pipeline) {
			...
			if (
				pipeline.title === undefined ||
				pipeline.title === "" ||
				pipeline.title === DEFAULT_BOOK_TITLE
			) {
				return false;
			}
			if (
				!pipeline.personas.every(
					(persona) => persona.modelRequirements !== undefined,
				)
			) {
				return false;
			}
			if (
				!pipeline.knowledgeSources.every(
					(knowledgeSource) => knowledgeSource.preparationIds !== undefined,
				)
			) {
				return false;
			}
      ...
      */
		...
		function addUsage() {
			...
			return usageItems.reduce((acc, item) => {
				...
				var _c;
				acc.price.value +=
					((_c = item.price) === null || _c === void 0 ? void 0 : _c.value) ||
					0;
				try {
					for (
						var _d = __values(Object.keys(acc.input)), _e = _d.next();
						!_e.done;
						_e = _d.next()
					) {
						var key = _e.value;
				...
				try {
					for (
						var _f = __values(Object.keys(acc.output)), _g = _f.next();
						!_g.done;
						_g = _f.next()
					) {
						var key = _g.value;
						...
						"\n                    Can not extract variables from the script\n                    "
							...
							.concat(
								Array.from(variables)
									.map((variableName, i) =>
										"".concat(i + 1, ") ").concat(variableName),
									)
									.join("\n"),
								"\n\n\n                    The script:\n\n                    ```javascript\n                    ",
							)
		...
		function extractParameterNamesFromTask(task) {
			...
			var title = task.title,
				...
				taskType = task.taskType,
				content = task.content,
				preparedContent = task.preparedContent,
				jokerParameterNames = task.jokerParameterNames,
							...
							__spreadArray(
								__spreadArray(
									__spreadArray(
										__spreadArray(
											[],
											__read(extractParameterNames(title)),
											false,
										),
										__read(extractParameterNames(description || "")),
										false,
									),
									__read(extractParameterNames(content)),
									false,
								),
								__read(extractParameterNames(preparedContent || "")),
								false,
							),
						),
						_f = _e.next();
			...
			if (taskType === "SCRIPT_TASK") {
				try {
					for (
						var _g = __values(extractVariablesFromScript(content)),
							_h = _g.next();
						!_h.done;
						_h = _g.next()
					) {
			...
			try {
				for (
					var _j = __values(jokerParameterNames || []), _k = _j.next();
					!_k.done;
					_k = _j.next()
				) {
			...
			if (foreach !== undefined) {
				try {
					for (
						var _l = __values(foreach.inputSubparameterNames), _m = _l.next();
						!_m.done;
						_m = _l.next()
					) {
		...
		function difference(a, b, isEqual) {
			...
			try {
				for (
					var _b = __values(Array.from(a)), _c = _b.next();
					!_c.done;
					_c = _b.next()
				) {
					var itemA = _c.value;
		...
		function union() {
			...
			try {
				for (
					var sets_1 = __values(sets), sets_1_1 = sets_1.next();
					!sets_1_1.done;
					sets_1_1 = sets_1.next()
				) {
					var set = sets_1_1.value;
					try {
						for (
							var _c = ((e_2 = void 0), __values(Array.from(set))),
								_d = _c.next();
							!_d.done;
							_d = _c.next()
						) {
		...
		var CsvFormatDefinition = {
			...
			isValid: (value, settings, schema) => true,
			canBeValid: (partialValue, settings, schema) => true,
							...
							return __generator(this, (_a) => {
								switch (_a.label) {
									case 0:
										csv = papaparse.parse(
											value,
											__assign(__assign({}, settings), MANDATORY_CSV_SETTINGS),
										);
															...
															switch (_d.label) {
																case 0:
																	if (row[outputParameterName]) {
																		throw new CsvFormatError(
																			'Can not overwrite existing column "'.concat(
																				outputParameterName,
																				'" in CSV row',
																			),
																		);
													...
													__awaiter(this, void 0, void 0, function () {
														return __generator(this, (_a) => [
															...
															/* not await */ Promise.all(
																Object.entries(row).map((_a, columnIndex) => {
																	var _b = __read(_a, 2),
																		key = _b[0],
																		value = _b[1];
																	return __awaiter(
		...
		var JsonFormatDefinition = {
			...
			isValid: (value, settings, schema) => isValidJsonString(value),
			canBeValid: (partialValue, settings, schema) => true,
			heal: (value, settings, schema) => {
				throw new Error("Not implemented");
			},
		...
		var TextFormatDefinition = {
			...
			canBeValid: (partialValue) => typeof partialValue === "string",
			heal: () => {
				throw new UnexpectedError(
		...
		function mapAvailableToExpectedParameters(options) {
			var e_1, _a;
			var expectedParameters = options.expectedParameters,
				availableParameters = options.availableParameters;
			...
			try {
				...
				for (
					var _b = __values(
							Array.from(
								union(availableParametersNames, expectedParameterNames),
							),
						),
						_c = _b.next();
					!_c.done;
					...
					if (
						availableParametersNames.has(parameterName) &&
						expectedParameterNames.has(parameterName)
					) {
						mappedParameters[parameterName] =
							availableParameters[parameterName];
							...
							.concat(
								block(
									Object.keys(mappedParameters)
										.map((parameterName) => "- {".concat(parameterName, "}"))
										.join("\n"),
								),
			...
			for (var i = 0; i < expectedParameterNames.size; i++) {
				mappedParameters[expectedParameterNamesArray[i]] =
					availableParameters[availableParametersNamesArray[i]];
			}
			// Note: [👨‍👨‍👧] Now we can freeze `mappedParameters` to prevent @@@
			Object.freeze(mappedParameters);
			return mappedParameters;
		...
		function extractAllBlocksFromMarkdown(markdown) {
			...
			try {
				for (
					var lines_1 = __values(lines), lines_1_1 = lines_1.next();
					!lines_1_1.done;
						...
						if (currentCodeBlock === null) {
							...
							if (language !== null) {
								throw new ParseError(
									""
										.concat(
											capitalize(currentCodeBlock.language || "the"),
											" code block was not closed and already opening new ",
										)
										.concat(language, " code block"),
								);
							}
							codeBlocks.push(currentCodeBlock);
							currentCodeBlock = null;
		...
		function extractJsonBlock(markdown) {
			...
			var jsonBlocks = codeBlocks.filter((_a) => {
		...
		function templateParameters(template, parameters) {
			...
			try {
				for (
					var _b = __values(Object.entries(parameters)), _c = _b.next();
					!_c.done;
					_c = _b.next()
				) {
					var _d = __read(_c.value, 2),
					...
					if (parameterValue === RESERVED_PARAMETER_MISSING_VALUE) {
						throw new UnexpectedError(
							"Parameter `{".concat(parameterName, "}` has missing value"),
						);
					} else if (parameterValue === RESERVED_PARAMETER_RESTRICTED) {
						// TODO: [🍵]
						throw new UnexpectedError(
							"Parameter `{".concat(parameterName, "}` is restricted to use"),
						);
					}
				}
			} catch (e_1_1) {
			...
			var _loop_1 = () => {
				...
				if (parameterValue.includes("\n") && /^\s*\W{0,3}\s*$/.test(precol)) {
					parameterValue = parameterValue
						.split("\n")
						.map((line, index) =>
							index === 0 ? line : "".concat(precol).concat(line),
						)
						.join("\n");
				}
				replacedTemplates =
			...
			while (
				(match =
					/^(?<precol>.*){(?<parameterName>\w+)}(.*)/m /* <- Not global */
		...
		function countCharacters(text) {
			...
			text = text.replace(
				/(\p{Extended_Pictographic})\p{Modifier_Symbol}/gu,
				"$1",
			);
			text = text.replace(
				/(\p{Extended_Pictographic})[\u{FE00}-\u{FE0F}]/gu,
				"$1",
			);
			text = text.replace(
				/\p{Extended_Pictographic}(\u{200D}\p{Extended_Pictographic})*/gu,
				"-",
			);
			return text.length;
		}
  ...
  */
		...
		function removeDiacritics(input) {
			...
			return input.replace(
				/[^\u0000-\u007E]/g,
				(a) => DIACRITIC_VARIANTS_LETTERS[a] || a,
			);
		}
		/**
		...
		function countWords(text) {
			...
			return text.split(/[^a-zа-я0-9]+/i).filter((word) => word.length > 0)
				.length;
		}
		...
		function checkExpectations(expectations, value) {
			...
			try {
				for (
					var _b = __values(Object.entries(expectations)), _c = _b.next();
					!_c.done;
					_c = _b.next()
				) {
					var _d = __read(_c.value, 2),
					...
					switch (_a.label) {
						case 0:
							(jokerParameterNames = options.jokerParameterNames),
								...
								(preparedContent = options.preparedContent),
							...
							llmTools =
								_llms.length === 1
									? _llms[0]
									: joinLlmExecutionTools.apply(
											void 0,
											__spreadArray([], __read(_llms), false),
										);
							_loop_1 = function (attempt) {
								...
								return __generator(this, (_t) => {
									switch (_t.label) {
										case 0:
											isJokerAttempt = attempt < 0;
											jokerParameterName =
												jokerParameterNames[
													jokerParameterNames.length + attempt
												];
										...
										case 1:
											...
											return [3 /*break*/, 24];
										case 2:
											$ongoingTaskResult.$resultString = templateParameters(
												preparedContent,
												parameters,
											);
											return [3 /*break*/, 25];
										case 3:
											modelRequirements = __assign(
												__assign(
													{ modelVariant: "CHAT" },
											...
											$ongoingTaskResult.$prompt = {
												...
												expectations: __assign(
													__assign(
														{},
														preparedPipeline.personas.find((_a) => {
															var name = _a.name;
												...
												postprocessingFunctionNames:
													task.postprocessingFunctionNames,
										...
										case 5:
											...
											$ongoingTaskResult.$result =
												$ongoingTaskResult.$chatResult;
											$ongoingTaskResult.$resultString =
												$ongoingTaskResult.$chatResult.content;
											return [3 /*break*/, 10];
										case 6:
											_e = $ongoingTaskResult;
											return [
												4 /*yield*/,
												llmTools.callCompletionModel(
										...
										case 7:
											...
											$ongoingTaskResult.$result =
												$ongoingTaskResult.$completionResult;
											$ongoingTaskResult.$resultString =
												$ongoingTaskResult.$completionResult.content;
											return [3 /*break*/, 10];
										case 8:
											throw new PipelineExecutionError(
												spaceTrim.spaceTrim((block) =>
											...
											throw new PipelineExecutionError(
												spaceTrim.spaceTrim((block) =>
													'\n                                                Unknown model variant "'
														.concat(
															task.modelRequirements.modelVariant,
															'"\n\n                                                ',
														)
														.concat(
															block(pipelineIdentification),
										...
										case 11:
											...
											if (!task.contentLanguage) {
												throw new PipelineExecutionError(
													spaceTrim.spaceTrim((block) =>
														'\n                                        Script language is not defined for SCRIPT TASK "'
															.concat(
																task.name,
																'"\n\n                                        ',
															)
										...
										case 12:
											...
											(_f =
												((e_1 = void 0),
												__values(arrayableToArray(tools.script)))),
												(_g = _f.next());
											_t.label = 13;
										case 13:
										...
										case 16:
											...
											$ongoingTaskResult.$scriptPipelineExecutionErrors.push(
												error_1,
											);
											return [3 /*break*/, 17];
										case 17:
										...
										case 21:
											...
											if (
												...
												throw $ongoingTaskResult
													.$scriptPipelineExecutionErrors[0];
											} else {
												throw new PipelineExecutionError(
													spaceTrim.spaceTrim((block) =>
														"\n                                        Script execution failed "
															.concat(
																$ongoingTaskResult
																	.$scriptPipelineExecutionErrors.length,
																"x\n\n                                        ",
															)
															.concat(
																block(pipelineIdentification),
										...
										case 22:
											...
											return [
												4 /*yield*/,
												tools.userInterface.promptDialog(
													$deepFreeze({
														promptTitle: task.title,
														promptMessage: templateParameters(
															task.description || "",
															parameters,
														),
														defaultValue: templateParameters(
															preparedContent,
															parameters,
														),
										...
										case 25:
											if (
												!(!isJokerAttempt && task.postprocessingFunctionNames)
											)
												return [3 /*break*/, 42];
											_t.label = 26;
										case 26:
											...
											(_k =
												((e_3 = void 0),
												__values(task.postprocessingFunctionNames))),
												(_l = _k.next());
											_t.label = 27;
										case 27:
										...
										case 30:
											...
											return [
												...
												scriptTools.execute({
													scriptLanguage:
														"javascript" /* <- TODO: Try it in each languages; In future allow postprocessing with arbitrary combination of languages to combine */,
												...
												throw new PipelineExecutionError(
													spaceTrim.spaceTrim((block) => {
														...
														return "\n                        LLM execution failed "
															...
															.concat(
																((_b = $ongoingTaskResult.$expectError) ===
																	null || _b === void 0
																	? void 0
																	: _b.name) || "",
																":\n                        ",
															...
															.concat(
																block(
																	(
																		((_c = $ongoingTaskResult.$expectError) ===
																			null || _c === void 0
																			? void 0
																			: _c.message) || ""
																	)
				...
				return __generator(this, (_a) => {
					switch (_a.label) {
						case 0:
							...
							formatDefinition = FORMAT_DEFINITIONS.find((formatDefinition) =>
								__spreadArray(
									[formatDefinition.formatName],
									__read(formatDefinition.aliases || []),
									false,
								).includes(task.foreach.formatName),
							);
								...
								throw new UnexpectedError(
									...
									spaceTrim__default["default"]((block) =>
										'\n                    Unsupported format "'
											...
											.concat(
												block(
													FORMAT_DEFINITIONS.map(
														(formatDefinition) => formatDefinition.formatName,
													)
														.map((formatName) => "- ".concat(formatName))
														.join("\n"),
												),
							...
							subvalueDefinition = formatDefinition.subvalueDefinitions.find(
								(subvalueDefinition) =>
									__spreadArray(
										[subvalueDefinition.subvalueName],
										__read(subvalueDefinition.aliases || []),
										false,
									).includes(task.foreach.subformatName),
							);
							if (subvalueDefinition === undefined) {
								throw new UnexpectedError(
									// <- TODO: [🧠][🧐] Should be formats fixed per promptbook version or behave as plugins (=> change UnexpectedError)
									spaceTrim__default["default"]((block) =>
										'\n                    Unsupported subformat name "'
											.concat(task.foreach.subformatName, '" for format "')
											.concat(
												task.foreach.formatName,
												'"\n\n                    Available subformat names for format "',
											)
											.concat(
												formatDefinition.formatName,
												'":\n                    ',
											...
											.concat(
												block(
													formatDefinition.subvalueDefinitions
														...
														.map((subvalueName) => "- ".concat(subvalueName))
														.join("\n"),
												),
															...
															mappedParameters =
																mapAvailableToExpectedParameters({
																	expectedParameters: Object.fromEntries(
																		task.foreach.inputSubparameterNames.map(
																			(subparameterName) => [
																				subparameterName,
																				null,
																			],
														...
														return [
															...
															executeAttempts(
																__assign(__assign({}, options), {
																	...
																	pipelineIdentification: spaceTrim__default[
																		"default"
																	]((block) =>
																		"\n                        "
																			.concat(
		...
		function getContextForTask(task) {
			return __awaiter(this, void 0, void 0, function () {
				return __generator(this, (_a) => [
					2 /*return*/,
					RESERVED_PARAMETER_MISSING_VALUE /* <- TODO: [🏍] Implement */,
				]);
			});
		}
		...
		function getKnowledgeForTask(options) {
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, (_a) => {
					...
					return [
						2 /*return*/,
						preparedPipeline.knowledgePieces
							.map((_a) => {
								var content = _a.content;
					...
					switch (_b.label) {
						...
						case 3:
							...
							try {
								...
								for (
									RESERVED_PARAMETER_NAMES_1 = __values(
										RESERVED_PARAMETER_NAMES,
									),
										RESERVED_PARAMETER_NAMES_1_1 =
											RESERVED_PARAMETER_NAMES_1.next();
									!RESERVED_PARAMETER_NAMES_1_1.done;
									RESERVED_PARAMETER_NAMES_1_1 =
										RESERVED_PARAMETER_NAMES_1.next()
								) {
								...
								try {
									if (
										RESERVED_PARAMETER_NAMES_1_1 &&
										!RESERVED_PARAMETER_NAMES_1_1.done &&
										(_a = RESERVED_PARAMETER_NAMES_1.return)
									)
										_a.call(RESERVED_PARAMETER_NAMES_1);
								} finally {
									if (e_1) throw e_1.error;
								}
							}
					...
					switch (_h.label) {
						case 0:
							(currentTask = options.currentTask),
								(preparedPipeline = options.preparedPipeline),
								(parametersToPass = options.parametersToPass),
								(tools = options.tools),
								(onProgress = options.onProgress),
								($executionReport = options.$executionReport),
								(pipelineIdentification = options.pipelineIdentification),
								(maxExecutionAttempts = options.maxExecutionAttempts),
								(maxParallelCount = options.maxParallelCount),
								(csvSettings = options.csvSettings),
								(isVerbose = options.isVerbose),
								(rootDirname = options.rootDirname),
								(cacheDirname = options.cacheDirname),
								(intermediateFilesStrategy = options.intermediateFilesStrategy),
								(isAutoInstalled = options.isAutoInstalled),
								(isNotPreparedWarningSupressed =
									options.isNotPreparedWarningSupressed);
							name = "pipeline-executor-frame-".concat(currentTask.name);
							title = currentTask.title;
							priority =
								preparedPipeline.tasks.length -
								preparedPipeline.tasks.indexOf(currentTask);
							return [
								4 /*yield*/,
								onProgress({
									name: name,
						...
						case 1:
							...
							dependentParameterNames = new Set(
								currentTask.dependentParameterNames,
							);
						...
						case 2:
							...
							_loop_1 = (parameterName) => {
								...
								if (
									definedParameterNames.has(parameterName) &&
									usedParameterNames.has(parameterName)
								) {
							...
							maxAttempts =
								currentTask.taskType === "DIALOG_TASK"
									? Number.POSITIVE_INFINITY
									: maxExecutionAttempts;
							jokerParameterNames = currentTask.jokerParameterNames || [];
							preparedContent = (currentTask.preparedContent || "{content}")
								.split("{content}")
								.join(currentTask.content);
							return [
								4 /*yield*/,
								executeFormatSubvalues({
		...
		function filterJustOutputParameters(options) {
			var e_1, _a;
			var preparedPipeline = options.preparedPipeline,
				parametersToPass = options.parametersToPass,
			...
			var _loop_1 = (parameter) => {
				...
				outputParameters[parameter.name] =
					parametersToPass[parameter.name] || "";
			};
			try {
				...
				for (
					var _b = __values(
							preparedPipeline.parameters.filter((_a) => {
								var isOutput = _a.isOutput;
								return isOutput;
							}),
						),
					...
					switch (_g.label) {
						case 0:
							(inputParameters = options.inputParameters),
								...
								(setPreparedPipeline = options.setPreparedPipeline),
								(pipelineIdentification = options.pipelineIdentification),
								(maxParallelCount = options.maxParallelCount),
								(rootDirname = options.rootDirname),
								(isVerbose = options.isVerbose);
							...
							return [
								4 /*yield*/,
								preparePipeline(pipeline, tools, {
									rootDirname: rootDirname,
									isVerbose: isVerbose,
									maxParallelCount: maxParallelCount,
								}),
						...
						case 6:
							return [
								...
								exportJson({
									...
									message:
										"Unuccessful PipelineExecutorResult (with missing parameter {".concat(
											parameter.name,
						...
						case 11:
							_loop_1 = function (parameterName) {
								...
								return __generator(this, (_h) => {
									switch (_h.label) {
										case 0:
											parameter = preparedPipeline.parameters.find((_a) => {
												var name = _a.name;
												...
												new PipelineExecutionError(
													spaceTrim.spaceTrim((block) =>
														"\n                            Extra parameter {"
															.concat(
																parameterName,
																"} is being passed which is not part of the pipeline.\n\n                            ",
															)
															.concat(
																block(pipelineIdentification),
																"\n                        ",
																	...
																	new PipelineExecutionError(
																		spaceTrim.spaceTrim((block) =>
																			"\n                                    Parameter `{"
																				.concat(
																					parameter.name,
																					"}` is passed as input parameter but it is not input\n\n                                    ",
																				)
																				.concat(
																					block(pipelineIdentification),
																					"\n                                ",
						...
						case 18:
							...
							return [7 /*endfinally*/];
						case 19:
							parametersToPass = Object.fromEntries(
								Object.entries(inputParameters).map((_a) => {
									var _b = __read(_a, 2),
										key = _b[0],
										value = _b[1];
						...
						case 20:
							...
							unresovedTasks_1 = __spreadArray(
								[],
								__read(preparedPipeline.tasks),
								false,
							);
							resolving_1 = [];
								...
								return __generator(this, (_j) => {
									switch (_j.label) {
										case 0:
											...
											currentTask = unresovedTasks_1.find((task) =>
												task.dependentParameterNames.every((name) =>
													__spreadArray(
														__spreadArray(
															[],
															__read(resovedParameterNames_1),
															false,
														),
														__read(RESERVED_PARAMETER_NAMES),
														false,
													).includes(name),
												),
											);
											if (!(!currentTask && resolving_1.length === 0))
												return [3 /*break*/, 1];
											throw new UnexpectedError(
												// TODO: [🐎] DRY
												spaceTrim.spaceTrim((block) =>
													"\n                            Can not resolve some parameters:\n\n                            "
														...
														.concat(
															block(
																unresovedTasks_1
																	.map((_a) => {
																		var resultingParameterName =
																				_a.resultingParameterName,
																			dependentParameterNames =
																				_a.dependentParameterNames;
																		return "- Parameter `{"
																			.concat(
																				resultingParameterName,
																				"}` which depends on ",
														...
														.concat(
															block(
																resovedParameterNames_1
																	.filter(
																		(name) =>
																			!RESERVED_PARAMETER_NAMES.includes(name),
																	)
																	.map((name) =>
																		"- Parameter `{".concat(name, "}`"),
																	)
																	.join("\n"),
															),
															"\n\n                            **Reserved (which are available):**\n                            ",
										...
										case 1:
											...
											/* [🤹‍♂️] */ return [
												4 /*yield*/,
												Promise.race(resolving_1),
											];
										case 2:
											/* [🤹‍♂️] */ _j.sent();
											return [3 /*break*/, 4];
										case 3:
											unresovedTasks_1 = unresovedTasks_1.filter(
											...
											work_1 = executeTask(
												...
												.then((newParametersToPass) => {
													parametersToPass = __assign(
														__assign({}, newParametersToPass),
														parametersToPass,
													);
													resovedParameterNames_1 = __spreadArray(
														__spreadArray(
															[],
															__read(resovedParameterNames_1),
															false,
												...
												.then(() => {
													resolving_1 = resolving_1.filter((w) => w !== work_1);
												});
						...
						case 22:
							...
							return [3 /*break*/, 21];
						case 23:
							return [4 /*yield*/, Promise.all(resolving_1)];
						case 24:
							_g.sent();
							return [3 /*break*/, 28];
						case 25:
							...
							usage_1 = addUsage.apply(
								void 0,
								__spreadArray(
									[],
									__read(
										executionReport.promptExecutions.map((_a) => {
											var result = _a.result;
											return (
												(result === null || result === void 0
													? void 0
													: result.usage) || ZERO_USAGE
											);
										}),
									),
									false,
						...
						case 27:
							return [
								...
								exportJson({
									...
									value: {
										isSuccessful: false,
										errors: __spreadArray([error_1], __read(errors), false).map(
											serializeError,
										),
										warnings: warnings.map(serializeError),
										usage: usage_1,
		...
		function createPipelineExecutor(options) {
			var pipeline = options.pipeline,
				tools = options.tools,
				_a = options.maxExecutionAttempts,
				maxExecutionAttempts =
					_a === void 0 ? DEFAULT_MAX_EXECUTION_ATTEMPTS : _a,
				_b = options.maxParallelCount,
				maxParallelCount = _b === void 0 ? DEFAULT_MAX_PARALLEL_COUNT : _b,
				_c = options.csvSettings,
				csvSettings = _c === void 0 ? DEFAULT_CSV_SETTINGS : _c,
				_d = options.isVerbose,
				isVerbose = _d === void 0 ? DEFAULT_IS_VERBOSE : _d,
				_e = options.isNotPreparedWarningSupressed,
				isNotPreparedWarningSupressed = _e === void 0 ? false : _e,
				_f = options.cacheDirname,
				cacheDirname = _f === void 0 ? DEFAULT_SCRAPE_CACHE_DIRNAME : _f,
				_g = options.intermediateFilesStrategy,
				intermediateFilesStrategy =
					_g === void 0 ? DEFAULT_INTERMEDIATE_FILES_STRATEGY : _g,
				_h = options.isAutoInstalled,
				isAutoInstalled = _h === void 0 ? DEFAULT_IS_AUTO_INSTALLED : _h,
				_j = options.rootDirname,
				rootDirname = _j === void 0 ? null : _j;
			validatePipeline(pipeline);
			var pipelineIdentification = (() => {
				// Note: This is a 😐 implementation of [🚞]
				var _ = [];
			...
			var runCount = 0;
			var pipelineExecutor = (inputParameters, onProgress) =>
				__awaiter(this, void 0, void 0, function () {
					return __generator(this, (_a) => {
						runCount++;
						return [
							2 /*return*/,
							/* not await */ executePipeline({
								pipeline: pipeline,
								preparedPipeline: preparedPipeline,
								...
								pipelineIdentification: spaceTrim.spaceTrim((block) =>
									"\n                    "
										...
										.concat(
											runCount === 1 ? "" : "Run #".concat(runCount),
											"\n                ",
										),
								),
								maxExecutionAttempts: maxExecutionAttempts,
		...
		function forEachAsync(array, options, callbackfunction) {
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, (_e) => {
					switch (_e.label) {
						case 0:
							(_a = options.maxParallelCount),
								(maxParallelCount =
									_a === void 0 ? Number.POSITIVE_INFINITY : _a);
							index = 0;
							runningTasks = [];
							tasks = [];
		...
		function countTotalUsage(llmTools) {
			...
			var proxyTools = {
				...
				checkConfiguration: function () {
					return __awaiter(this, void 0, void 0, function () {
						return __generator(this, (_a) => [
							2 /*return*/,
							/* not await */ llmTools.checkConfiguration(),
						]);
					});
				},
				listModels: () => llmTools.listModels(),
				getTotalUsage: () => {
			...
			if (llmTools.callChatModel !== undefined) {
				proxyTools.callChatModel = (prompt) =>
					__awaiter(this, void 0, void 0, function () {
						var promptResult;
						return __generator(this, (_a) => {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, llmTools.callChatModel(prompt)];
								case 1:
			...
			if (llmTools.callCompletionModel !== undefined) {
				proxyTools.callCompletionModel = (prompt) =>
					__awaiter(this, void 0, void 0, function () {
						var promptResult;
						return __generator(this, (_a) => {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, llmTools.callCompletionModel(prompt)];
								case 1:
									promptResult = _a.sent();
									totalUsage = addUsage(totalUsage, promptResult.usage);
									return [2 /*return*/, promptResult];
			...
			if (llmTools.callEmbeddingModel !== undefined) {
				proxyTools.callEmbeddingModel = (prompt) =>
					__awaiter(this, void 0, void 0, function () {
						var promptResult;
						return __generator(this, (_a) => {
							switch (_a.label) {
								case 0:
									return [4 /*yield*/, llmTools.callEmbeddingModel(prompt)];
								case 1:
									promptResult = _a.sent();
									totalUsage = addUsage(totalUsage, promptResult.usage);
									return [2 /*return*/, promptResult];
		...
		function preparePersona(personaDescription, tools, options) {
			return __awaiter(this, void 0, void 0, function () {
				...
				return __generator(this, (_d) => {
					switch (_d.label) {
						case 0:
							(_a = options.isVerbose),
								(isVerbose = _a === void 0 ? DEFAULT_IS_VERBOSE : _a);
							if (tools === undefined || tools.llm === undefined) {
								throw new MissingToolsError(
									"LLM tools are required for preparing persona",
								);
							}
							collection = createCollectionFromJson.apply(
								void 0,
								__spreadArray([], __read(PipelineCollection), false),
							);
							_b = createPipelineExecutor;
							_c = {};
							return [
								4 /*yield*/,
								collection.getPipelineByUrl(
									"https://promptbook.studio/promptbook/prepare-persona.book",
								),
							];
						case 1:
							preparePersonaExecutor = _b.apply(void 0, [
								((_c.pipeline = _d.sent()), (_c.tools = tools), _c),
							]);
							_llms = arrayableToArray(tools.llm);
							llmTools =
								_llms.length === 1
						...
						case 3:
							...
							if (isVerbose) {
								console.info(
									"PERSONA ".concat(personaDescription),
									modelRequirements,
								);
							}
		...
		function $registeredScrapersMessage(availableScrapers) {
			...
			var _loop_1 = (
				...
				all.push({
					...
					isAvilableInBrowser: isAvilableInBrowser,
				});
			};
			try {
				for (
					var _d = __values($scrapersMetadataRegister.list()), _e = _d.next();
					!_e.done;
					_e = _d.next()
				) {
					var _f = _e.value,
						...
						mimeTypes = _f.mimeTypes,
						documentationUrl = _f.documentationUrl,
						isAvilableInBrowser = _f.isAvilableInBrowser;
					_loop_1(
						packageName,
						className,
						mimeTypes,
			...
			try {
				for (
					var _g = __values($scrapersRegister.list()), _h = _g.next();
					!_h.done;
					_h = _g.next()
				) {
					var _j = _h.value,
						packageName = _j.packageName,
						className = _j.className,
						mimeTypes = _j.mimeTypes,
						documentationUrl = _j.documentationUrl,
						isAvilableInBrowser = _j.isAvilableInBrowser;
					_loop_2(
						packageName,
						className,
						mimeTypes,
			...
			try {
				for (
					var availableScrapers_1 = __values(availableScrapers),
						availableScrapers_1_1 = availableScrapers_1.next();
					!availableScrapers_1_1.done;
					availableScrapers_1_1 = availableScrapers_1.next()
				) {
				...
				try {
					if (
						availableScrapers_1_1 &&
						!availableScrapers_1_1.done &&
						(_c = availableScrapers_1.return)
					)
						_c.call(availableScrapers_1);
				} finally {
					if (e_3) throw e_3.error;
				}
			}
			var metadata = all.map((metadata) => {
				...
				var isInstalled = $scrapersRegister.list().find((_a) => {
					var packageName = _a.packageName,
						className = _a.className;
					return (
						metadata.packageName === packageName &&
				...
				var isAvilableInTools = availableScrapers.some((_a) => {
					var _b = _a.metadata,
				...
				return __assign(__assign({}, metadata), {
					isMetadataAviailable: isMetadataAviailable,
					isInstalled: isInstalled,
					isAvilableInTools: isAvilableInTools,
				});
			});
			if (metadata.length === 0) {
						...
						metadata
							.map((_a, i) => {
								var packageName = _a.packageName,
									...
									isMetadataAviailable = _a.isMetadataAviailable,
									isInstalled = _a.isInstalled,
									mimeTypes = _a.mimeTypes,
									isAvilableInBrowser = _a.isAvilableInBrowser,
									isAvilableInTools = _a.isAvilableInTools;
								var more = [];
								...
								var moreText =
									more.length === 0 ? "" : " *(".concat(more.join("; "), ")*");
								return ""
									.concat(i + 1, ") `")
									.concat(className, "` from `")
									.concat(packageName, "` compatible to scrape ")
									.concat(
										mimeTypes
											.map((mimeType) => '"'.concat(mimeType, '"'))
											.join(", "),
									)
									.concat(moreText);
							})
		...
		function knowledgeSourceContentToName(knowledgeSourceContent) {
			var hash = cryptoJs
				.SHA256(
					hexEncoder__default["default"].parse(
						JSON.stringify(knowledgeSourceContent),
					),
				)
			...
			var pieces = ["source", semanticName, hash].filter(
				(piece) => piece !== "",
			);
				...
				return __generator(this, (_f) => {
					switch (_f.label) {
						...
						case 1:
							response_1 = _f.sent();
							mimeType =
								((_a = response_1.headers.get("content-type")) === null ||
								_a === void 0
									? void 0
									: _a.split(";")[0]) || "text/html";
							return [
								2 /*return*/,
								{
									source: name,
						...
						case 2:
							...
							if (tools.fs === undefined) {
								throw new EnvironmentMismatchError(
									"Can not import file knowledge without filesystem tools",
								);
								//          <- TODO: [🧠] What is the best error type here`
							}
							if (rootDirname === null) {
								throw new EnvironmentMismatchError(
									"Can not import file knowledge in non-file pipeline",
								);
								//          <- TODO: [🧠] What is the best error type here`
							}
							filename_1 = path
								.join(rootDirname, knowledgeSourceContent)
								.split("\\")
								.join("/");
											...
											return __generator(this, (_c) => {
												switch (_c.label) {
													case 0:
														...
														return [
															4 /*yield*/,
															tools.fs.readFile(filename_1, "utf-8"),
														];
													case 1:
						...
						case 4:
							return [
								2 /*return*/,
								{
									...
									asText: () => knowledgeSource.knowledgeSourceContent,
									asJson: () => {
										throw new UnexpectedError(
				...
				return __generator(this, (_c) => {
					switch (_c.label) {
						case 0:
							(_a = options.maxParallelCount),
								(maxParallelCount =
									_a === void 0 ? DEFAULT_MAX_PARALLEL_COUNT : _a),
								(rootDirname = options.rootDirname),
								(_b = options.isVerbose),
								(isVerbose = _b === void 0 ? DEFAULT_IS_VERBOSE : _b);
											...
											return __generator(this, (_b) => {
												switch (_b.label) {
														...
														_loop_1 = function (scraper) {
															...
															return __generator(this, (_c) => {
																switch (_c.label) {
																	case 0:
																		if (
																			!scraper.metadata.mimeTypes.includes(
																				sourceHandler.mimeType,
																			)
																		...
																		return [
																			4 /*yield*/,
																			scraper.scrape(sourceHandler),
																		];
																	case 1:
																		partialPiecesUnchecked = _c.sent();
																		if (partialPiecesUnchecked !== null) {
																			partialPieces = __spreadArray(
																				[],
																				__read(partialPiecesUnchecked),
																				false,
																			);
													...
													case 9:
																...
																spaceTrim__default["default"]((block) =>
																	"\n                        Cannot scrape knowledge\n\n                        The source:\n                        > "
																		.concat(
																			...
																			'\n\n                        No scraper found for the mime type "',
																		)
																		.concat(
																			sourceHandler.mimeType,
																			'"\n\n                        ',
																		...
																		.concat(
																			block(
																				$registeredScrapersMessage(scrapers),
																			),
																			"\n\n\n                    ",
																		),
																),
														...
														pieces = partialPieces.map((partialPiece) =>
															__assign(__assign({}, partialPiece), {
																sources: [
																	{
																		name: knowledgeSource.name,
																		// line, column <- TODO: [☀]
  ...
  */
				...
				return __generator(this, (_b) => {
					switch (_b.label) {
						case 0:
							...
							(tasks = pipeline.tasks),
								pipeline.parameters,
								(knowledgePiecesCount = pipeline.knowledgePiecesCount);
										...
										__awaiter(this, void 0, void 0, function () {
											...
											return __generator(this, (_a) => {
												...
												if (
													...
													dependentParameterNames = __spreadArray(
														__spreadArray(
															[],
															__read(dependentParameterNames),
															false,
														),
														["knowledge"],
														false,
												...
												preparedTask = __assign(__assign({}, task), {
													dependentParameterNames: dependentParameterNames,
													preparedContent: preparedContent,
												});
		...
		function preparePipeline(pipeline, tools, options) {
          ...
          <- TODO: [🧊] `preparations` */,
					...
					title,
					collection,
					prepareTitleExecutor,
					_c,
					result,
					outputParameters,
					titleRaw,
					preparedPersonas,
					knowledgeSourcesPrepared,
					partialknowledgePiecesPrepared,
					knowledgePiecesPrepared,
					tasksPrepared /* TODO: parameters: parametersPrepared*/;
				var _d;
				return __generator(this, (_e) => {
					...
					switch (_e.label) {
						...
						case 1:
							prepareTitleExecutor = _c.apply(void 0, [
								((_d.pipeline = _e.sent()), (_d.tools = tools), _d),
							]);
							return [
								4 /*yield*/,
								prepareTitleExecutor({
												...
												switch (_a.label) {
													case 0:
														return [
															...
															preparePersona(
																persona.description,
																__assign(__assign({}, tools), {
																	llm: llmToolsWithUsage,
																}),
																{
																	rootDirname: rootDirname,
																	maxParallelCount:
													...
													case 1:
														...
														preparedPersona = __assign(__assign({}, persona), {
															modelRequirements: modelRequirements,
															preparationIds: [
																/* TODO: [🧊] -> */ currentPreparation.id,
															],
														});
						...
						case 4:
							_e.sent();
							knowledgeSourcesPrepared = knowledgeSources.map((source) =>
						...
						case 5:
							...
							knowledgePiecesPrepared = partialknowledgePiecesPrepared.map(
								(piece) =>
									__assign(__assign({}, piece), {
										preparationIds: [/* TODO: [🧊] -> */ currentPreparation.id],
									}),
							);
							return [
							...
							return [
								...
								exportJson({
									...
									value: __assign(__assign({}, pipeline), {
										...
										tasks: __spreadArray([], __read(tasksPrepared), false),
										// <- TODO: [🪓] Here should be no need for spreading new array, just ` tasks: tasksPrepared`
										personas: preparedPersonas,
										preparations: __spreadArray(
											[],
											__read(preparations),
											false,
										),
		...
		function startRemoteServer(options) {
			var _a = __assign(
				...
				createLlmExecutionTools = _a.createLlmExecutionTools,
				isAnonymousModeAllowed = _a.isAnonymousModeAllowed,
				isApplicationModeAllowed = _a.isApplicationModeAllowed,
				_b = _a.isVerbose,
				isVerbose = _b === void 0 ? DEFAULT_IS_VERBOSE : _b;
			// <- TODO: [🦪] Some helper type to be able to use discriminant union types with destructuring
			var httpServer = http__default["default"].createServer(
				{},
				(request, response) =>
					__awaiter(this, void 0, void 0, function () {
						var _a, _b;
						...
						return __generator(this, (_d) => {
							switch (_d.label) {
								case 0:
									if (
										(_c = request.url) === null || _c === void 0
											? void 0
											: _c.includes("socket.io")
									) {
										return [2 /*return*/];
									}
			...
			server.on("connection", (socket) => {
				if (isVerbose) {
					console.info(
						colors__default["default"].gray("Client connected"),
						socket.id,
					);
				}
				var getExecutionToolsFromIdentification = (identification) =>
					__awaiter(this, void 0, void 0, function () {
						var isAnonymous,
							llm,
							...
							switch (_b.label) {
								case 0:
									...
									if (isAnonymous === true && !isAnonymousModeAllowed) {
										throw new PipelineExecutionError(
											"Anonymous mode is not allowed",
										); // <- TODO: [main] !!3 Test
									}
									if (isAnonymous === false && !isApplicationModeAllowed) {
										throw new PipelineExecutionError(
											"Application mode is not allowed",
										); // <- TODO: [main] !!3 Test
									}
								...
								case 1:
									if (
										!(isAnonymous === false && createLlmExecutionTools !== null)
									)
										return [3 /*break*/, 3];
									(appId = identification.appId),
										(userId = identification.userId),
										(customOptions = identification.customOptions);
									return [
										4 /*yield*/,
								...
								case 6:
									tools = ((_a.scrapers = _b.sent()), _a);
									return [2 /*return*/, tools];
							}
						});
					});
				// -----------
				socket.on("prompt-request", (request) =>
					__awaiter(this, void 0, void 0, function () {
						var identification,
							prompt,
							executionTools,
						...
						return __generator(this, (_c) => {
							switch (_c.label) {
								case 0:
									...
									if (isVerbose) {
										console.info(
											colors__default["default"].bgWhite("Prompt:"),
											colors__default["default"].gray(
								...
								case 1:
									...
									return [
										4 /*yield*/,
										getExecutionToolsFromIdentification(identification),
									];
								case 2:
									executionTools = _c.sent();
									llm = executionTools.llm;
									_a =
										identification.isAnonymous === false && collection !== null;
									if (!_a) return [3 /*break*/, 4];
									return [
										4 /*yield*/,
										collection.isResponsibleForPrompt(prompt),
									];
								case 3:
									_a = !_c.sent();
									_c.label = 4;
								...
								case 12:
									if (isVerbose) {
										console.info(
											colors__default["default"].bgGreen("PromptResult:"),
											colors__default["default"].green(
												JSON.stringify(promptResult, null, 4),
											),
										);
									}
									socket.emit(
										"prompt-response",
										{ promptResult: promptResult } /* <- Note: [🤛] */,
									);
									return [3 /*break*/, 15];
								case 13:
									error_1 = _c.sent();
				...
				socket.on("listModels-request", (request) =>
					__awaiter(this, void 0, void 0, function () {
						...
						return __generator(this, (_a) => {
							switch (_a.label) {
								case 0:
									...
									if (isVerbose) {
										console.info(
											colors__default["default"].bgWhite("Listing models"),
										);
									}
									_a.label = 1;
								case 1:
				...
				// -----------
				// TODO: [👒] Listing models (and checking configuration) probbably should go through REST API not Socket.io
				socket.on("preparePipeline-request", (request) =>
					__awaiter(this, void 0, void 0, function () {
							...
							return __generator(this, (_a) => {
								...
								switch (_a.label) {
									case 0:
										...
										if (isVerbose) {
											console.info(
												colors__default["default"].bgWhite("Prepare pipeline"),
											);
										}
										_a.label = 1;
									case 1:
									...
									case 2:
										...
										return [
											4 /*yield*/,
											preparePipeline(pipeline, executionTools, options),
										];
									case 3:
										console.log(3);
									...
									case 4:
										...
										console.log(4, "b");
										console.log(
											"error_3 instanceof NotYetImplementedError",
											error_3 instanceof NotYetImplementedError,
										);
				...
				socket.on("disconnect", () => {
					...
					if (isVerbose) {
						console.info(
							colors__default["default"].gray("Client disconnected"),
							socket.id,
						);
					}
				});
			...
			console.info(
				colors__default["default"].bgGreen(
					"PROMPTBOOK server listening on port ".concat(port),
				),
			);
			if (isVerbose) {
				console.info(
					colors__default["default"].gray("Verbose mode is enabled"),
				);
			}
