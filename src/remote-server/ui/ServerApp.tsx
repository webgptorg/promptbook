    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="space-y-2">
        ...
        <KeyVal
          ...
          value={String(info.runningExecutions)}
        />
      </div>
...
/**
 * Render full HTML for the server index using React SSR.
 * Kept separate to follow DRY and allow future hydration without rewriting server code.
 */
export function renderServerIndexHtml(info: ServerInfo): string {
  return '<!DOCTYPE html>' + renderToStaticMarkup(<HtmlDoc info={info} />);
}
