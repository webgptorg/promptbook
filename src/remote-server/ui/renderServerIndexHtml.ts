    ...
    h(
      ...
      h(
        ...
        h(
          ...
          h(
            'a',
            { href: 'https://www.npmjs.com/package/@promptbook/remote-client', className: 'text-blue-600 underline' },
      ...
      h(
        ...
        h('a', { href: 'https://github.com/webgptorg/promptbook', className: 'text-blue-600 underline' }, 'https://github.com/webgptorg/promptbook'),
      ),
    ),
  );
}
...
function HtmlDoc({ info }: { info: ServerInfo }) {
  return h(
    ...
    h(
      ...
      h('div', { id: 'root' }, h(ServerBody, { info })),
    ),
  );
}
