 ...
 */
export async function executeFormatSubvalues(
	options: ExecuteFormatCellsOptions,
): Promise<TODO_any> {
	const {
		task,
		jokerParameterNames,
			...
			try {
				mappedParameters = mapAvailableToExpectedParameters({
					expectedParameters: Object.fromEntries(
						task.foreach!.inputSubparameterNames.map((subparameterName) => [
							subparameterName,
							null,
						]),
					),
