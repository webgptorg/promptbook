...
export async function executeTask(
	...
	const priority =
		preparedPipeline.tasks.length - preparedPipeline.tasks.indexOf(currentTask);
	...
	const maxAttempts =
		currentTask.taskType === "DIALOG_TASK"
			...
			: maxExecutionAttempts; // <- Note: [💂]
	const jokerParameterNames = currentTask.jokerParameterNames || [];

	const preparedContent = (currentTask.preparedContent || "{content}")
		.split("{content}")
