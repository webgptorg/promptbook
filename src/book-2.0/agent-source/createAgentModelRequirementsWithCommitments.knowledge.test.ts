...
`);
        ...
        expect(requirements.systemMessage).toContain('Source URL: https://example.com/alpha.pdf');
        expect(requirements.systemMessage).toContain('Source URL: https://example.com/beta.txt');
...
`);
        ...
        expect(requirements.systemMessage).not.toContain('Inline source:');
    });
});
