...
import { isPromptMarked } from '../utils/parameters/templateParameters';
import { removePromptMarker } from '../utils/parameters/templateParameters';
...
export { isPromptMarked };
export { removePromptMarker };
