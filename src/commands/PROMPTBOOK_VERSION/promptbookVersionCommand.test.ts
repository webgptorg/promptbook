...
describe('how PROMPTBOOK_ENGINE_VERSION command in .ptbk.md files works', () => {
    it('should parse PROMPTBOOK_ENGINE_VERSION command', () => {
        ...
        expect(parseCommand(`PROMPTBOOK version ${PROMPTBOOK_ENGINE_VERSION}`, 'PIPELINE_HEAD')).toEqual({
            type: 'PROMPTBOOK_ENGINE_VERSION',
            promptbookVersion: PROMPTBOOK_ENGINE_VERSION,
        });
    });

    it('should fail parsing PROMPTBOOK_ENGINE_VERSION command', () => {
