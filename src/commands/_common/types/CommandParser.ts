 ...
 * @public exported from `@promptbook/editable`
 */
export type PipelineBothCommandParser<TCommand extends CommandBase> =
	___and___ &
 ...
 * @public exported from `@promptbook/editable`
 */
export type PipelineHeadCommandParser<TCommand extends CommandBase> =
	CommonCommandParser<TCommand> & {
		/**
		 * @@@
		 */
 ...
 * @public exported from `@promptbook/editable`
 */
export type PipelineTaskCommandParser<TCommand extends CommandBase> =
	CommonCommandParser<TCommand> & {
		/**
		 * @@@
		 */
 ...
 * @private internal helper for command parsers
 */
export type $PipelineJson = WritableDeep<
	SetOptional<PipelineJson, "formfactorName">
>;
