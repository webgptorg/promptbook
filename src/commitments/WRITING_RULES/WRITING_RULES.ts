 ...
 */
export class WritingRulesCommitmentDefinition extends BaseCommitmentDefinition<'WRITING RULES' | 'WRITING RULE'> {
    public constructor(type: 'WRITING RULES' | 'WRITING RULE' = 'WRITING RULES') {
        super(type);
    }
