...
describe('promptbookStringToJson', () => {
    it('should fail on invalid language block', () => {
        expect(() =>
            promptbookStringToJson(
                importPromptbook('../../../samples/templates/errors/syntax/invalid-language.ptbk.md'),
            ),
    ...
    it('should fail on missing return declaration', () => {
        expect(() =>
            promptbookStringToJson(
                importPromptbook('../../../samples/templates/errors/syntax/missing-return-1.ptbk.md'),
            ),
    ...
    it('should fail on invalid return declaration', () => {
        expect(() =>
            promptbookStringToJson(
                importPromptbook('../../../samples/templates/errors/syntax/missing-return-2.ptbk.md'),
            ),
    ...
    it('should fail on multiple prompts in one prompt template', () => {
        expect(() =>
            promptbookStringToJson(
                importPromptbook('../../../samples/templates/errors/syntax/multiple-blocks.ptbk.md'),
            ),
        ).toThrowError(/There should be exactly one code block in the markdown/i);
    });
