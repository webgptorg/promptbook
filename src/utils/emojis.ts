 ...
 */
export const EMOJIS_IN_CATEGORIES: Record<
	string,
	ReadonlyArray<string_char_emoji>
> = {
	Smileys:
		"😀 😃 😄 😁 😆 😅 😂 🤣 🥲 ☺️ 😊 😇 🙂 🙃 😉 😌 😍 🥰 😘 😗 😙 😚 😋 😛 😝 😜 🤪 🤨 🧐 🤓 😎 🥸 🤩 🥳 😏 😒 😞 😔 😟 😕 🙁 ☹️ 😣 😖 😫 😩 🥺 😢 😭 😤 😠 😡 🤬 🤯 😳 🥵 🥶 😱 😨 😰 😥 😓 🤗 🤔 🤭 🤫 🤥 😶 😐 😑 😬 🙄 😯 😦 😧 😮 😲 🥱 😴 🤤 😪 😵 🤐 🥴 🤢 🤮 🤧 😷 🤒 🤕 🤑 🤠 😈 👿 👹 👺 🤡 💩 👻 💀 ☠️ 👽 👾 🤖 🎃 😺 😸 😹 😻 😼 😽 🙀 😿 😾".split(
			" ",
	...
	"New Emojis (Discorered randomly)": "🖌️".split(
		" ",
	) as ReadonlyArray<string_char_emoji>,

	"Emojis used in WebGPT": [
		"▶",
		"❤",
	] as TODO_any as ReadonlyArray<string_char_emoji>,
};
 ...
 * @deprecated Use /\p{Extended_Pictographic}/ instead
 */
export const EMOJIS: Set<string_char_emoji> = new Set(
	Object.values(EMOJIS_IN_CATEGORIES).flat(),
);
