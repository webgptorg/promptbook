...
describe("unwrapResult", () => {
	...
	it("should preserve unquoted sentence", () => {
		expect(unwrapResult("Hello WebGPT how are you?!")).toBe(
	...
	it("should remove quotes with leading sentence", () => {
		expect(unwrapResult('Návrh názvu: "Kreativní Dětský Svět"')).toBe(
	...
	it("should work in real-world scenarios", () => {
		expect(unwrapResult("\n\n" + `UnicornTech Solutions`)).toBe(
			just("UnicornTech Solutions"),
		);
	});
});
