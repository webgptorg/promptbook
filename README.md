...
Explore the `examples/` directory for ready-to-use Promptbook applications:

-   **Basic**: Hello World, simple parameter usage
-   **Advanced**: Article writer with persona and knowledge
-   **Chatbots**: Simple conversational AI

To try an example, open the `.book` file in VSCode with the Promptbook extension for syntax highlighting and validation.
