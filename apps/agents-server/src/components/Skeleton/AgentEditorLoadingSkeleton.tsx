...
export function AgentEditorLoadingSkeleton({ showSidePanel = true }: AgentEditorLoadingSkeletonProps) {
    return (
        <div
            className="agents-server-viewport-width min-h-[calc(100dvh-60px)] w-full bg-slate-100/80 p-4 md:p-6"
            role="status"
            aria-live="polite"
            aria-busy="true"
        ...
        >
            <div className="flex min-h-[calc(100dvh-92px)] gap-4">
                <section className="flex min-h-0 min-w-0 flex-1 flex-col overflow-hidden rounded-[26px] border border-slate-200 bg-white shadow-lg shadow-slate-900/5">
                    ...
                    <div className="flex min-h-0 flex-1 overflow-hidden">
                        <div className="hidden w-14 shrink-0 flex-col gap-3 border-r border-slate-200 bg-slate-50/70 px-3 py-5 md:flex">
                ...
                {showSidePanel && (
                    <aside className="hidden w-80 shrink-0 flex-col gap-4 rounded-[24px] border border-slate-200 bg-white/90 p-4 shadow-lg shadow-slate-900/5 xl:flex">
                        <Skeleton className="h-4 w-32 rounded-md" />
