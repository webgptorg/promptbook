...
import type { GraphSummaryInfo, ConnectionType } from './AgentsGraph.types';
import { CONNECTION_TYPES } from './AgentsGraph.types';
import { EDGE_LABELS, EDGE_STYLES } from './graphConstants';
            ...
            {CONNECTION_TYPES.map((type) => {
                ...
                return (
                    ...
                    >
                        ...
                        <span className="text-sm font-semibold text-slate-900">{connectionCountByType[type] ?? 0}</span>
                    </div>
                );
            })}
        </div>
