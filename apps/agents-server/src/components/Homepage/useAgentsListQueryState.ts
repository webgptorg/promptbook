...
/**
 * Reads the homepage route query and keeps folder and visibility updates localized in one place.
 *
...
export function useAgentsListQueryState(): UseAgentsListQueryStateResult {
    ...
    const isHiddenFoldersVisible = searchParams?.get(HIDDEN_FOLDERS_QUERY_PARAM) === HIDDEN_FOLDERS_VISIBLE_QUERY_VALUE;
