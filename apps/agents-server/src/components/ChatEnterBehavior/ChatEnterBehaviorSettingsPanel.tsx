                ...
                <div className="flex items-start gap-4">
                    <span
                        className={`inline-flex h-10 w-10 shrink-0 items-center justify-center rounded-2xl text-base font-semibold ${
                            isUndecidedSelected ? 'bg-amber-500 text-white' : 'bg-slate-100 text-slate-600'
                        }`}
                    >
                        ?
                    </span>
                    <div className="min-w-0 space-y-1">
                        <div className="flex flex-wrap items-center gap-2">
                            <p className="text-base font-semibold text-slate-900">{t('chatEnterBehavior.undecidedTitle')}</p>
                            {isUndecidedSelected && (
                        ...
                        <p className="text-sm leading-6 text-slate-600">{t('chatEnterBehavior.undecidedDescription')}</p>
                    </div>
                </div>
            </button>
