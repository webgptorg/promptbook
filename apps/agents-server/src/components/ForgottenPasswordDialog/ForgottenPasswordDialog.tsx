...
export function ForgottenPasswordDialog(props: ForgottenPasswordDialogProps) {
    ...
    return (
        <Dialog onClose={onClose} className="w-full max-w-md p-6">
            ...
            <div className="mb-6">
                <h2 className="text-xl font-semibold text-gray-900">{t('forgottenPassword.title')}</h2>
                <p className="text-sm text-gray-500 mt-1">{t('forgottenPassword.subtitle')}</p>
            </div>

            <div className="space-y-4">
                <div className="p-4 bg-blue-50 border border-blue-200 rounded-md">
                    <p className="text-sm text-blue-800">
                        {t('forgottenPassword.noEmailPrefix')}{' '}
                        <a
                        ...
                        {t('forgottenPassword.noEmailSuffix')}
                    </p>
                </div>
