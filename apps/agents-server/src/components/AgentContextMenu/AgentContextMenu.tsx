...
import { ContextMenuPanel } from '../ContextMenu/ContextMenuPanel';
import {
    useClampedMenuPosition,
    useCloseOnOutsideClick,
    type ContextMenuAnchorPoint,
} from '../ContextMenu/contextMenuUtils';
import { useAgentContextMenuItems } from './useAgentContextMenuItems';

export { useAgentContextMenuItems };
 ...
 *
 * @private type of AgentContextMenu
 */
export type AgentContextMenuBaseProps = {
    /**
