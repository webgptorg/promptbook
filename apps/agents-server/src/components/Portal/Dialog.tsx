...
const DEFAULT_DIALOG_SURFACE_CLASS_NAME =
    'relative rounded-lg border border-gray-200 bg-white shadow-lg animate-in zoom-in-95 duration-200 dark:border-slate-700 dark:bg-slate-950 dark:text-slate-100';
