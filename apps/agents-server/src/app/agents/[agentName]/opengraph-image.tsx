        ...
        (
            ...
            >
                ...
                <div style={{ flex: 1, display: 'flex', flexDirection: 'column', backgroundColor: 'white', position: 'relative' }}>
                    {/* Mock Header */}
                    <div style={{ height: '60px', borderBottom: '1px solid #e5e7eb', display: 'flex', alignItems: 'center', paddingLeft: '24px' }}>
                         <span style={{ fontSize: '18px', fontWeight: 600, color: '#111827' }}>Chat with {agentProfile.meta.fullname || agentProfile.agentName}</span>
                    </div>
                    
                    {/* Mock Chat bubbles */}
                    <div style={{ padding: '40px', display: 'flex', flexDirection: 'column', gap: '24px' }}>
                        <div style={{ display: 'flex', gap: '12px' }}>
                             <div style={{ width: '40px', height: '40px', borderRadius: '50%', backgroundColor: badgeColor, opacity: 0.1 }}></div>
                             <div style={{ backgroundColor: '#f3f4f6', padding: '16px', borderRadius: '0 16px 16px 16px', maxWidth: '80%' }}>
                                 <p style={{ margin: 0, color: '#374151' }}>Hello! I am {agentProfile.meta.fullname || agentProfile.agentName}. How can I help you today?</p>
                             </div>
                        </div>
                        ...
                        <div style={{ display: 'flex', gap: '12px', flexDirection: 'row-reverse' }}>
                             ...
                             <div style={{ backgroundColor: badgeColor, padding: '16px', borderRadius: '16px 0 16px 16px', maxWidth: '80%' }}>
                    ...
                    {/* Input area mock */}
                    <div style={{ position: 'absolute', bottom: '0', left: '0', right: '0', padding: '24px', borderTop: '1px solid #e5e7eb' }}>
                        <div style={{ height: '50px', borderRadius: '8px', border: '1px solid #e5e7eb', backgroundColor: '#f9fafb' }}></div>
                    </div>
                </div>
            </div>
        ),
