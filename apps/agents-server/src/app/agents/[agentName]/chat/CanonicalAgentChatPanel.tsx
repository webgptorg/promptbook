    ...
    const chatElement = (
        ...
        >
            {isReadOnly && frozenChatBannerLabel && (
                <div className="agent-chat-default-readonly-banner mx-4 mt-4 rounded-2xl px-4 py-3 text-sm font-medium">
    ...
    return (
        <>
            {isChatGptLikeVariant ? (
                ...
                <div className="agent-chat-default-panel flex h-full min-h-0 w-full flex-col overflow-hidden">
                    {chatElement}
                </div>
            )}
