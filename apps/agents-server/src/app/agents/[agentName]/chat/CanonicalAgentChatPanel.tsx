    ...
    const chatElement = (
        ...
        >
            {isReadOnly && frozenChatBannerLabel && (
                <div className="agent-chat-panel__read-only-banner mx-4 mt-4 rounded-2xl border border-amber-200 bg-amber-50/95 px-4 py-3 text-sm font-medium text-amber-900 shadow-sm">
