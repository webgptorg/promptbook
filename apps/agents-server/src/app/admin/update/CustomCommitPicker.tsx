        ...
        <div className="min-w-0 space-y-3">
            ...
            <div className="flex min-w-0 items-center justify-between gap-3">
                ...
                <button
                    ...
                    className="inline-flex shrink-0 items-center gap-2 self-end rounded-md border border-slate-300 bg-white px-3 py-2 text-xs font-semibold text-slate-700 hover:bg-slate-50 disabled:cursor-not-allowed disabled:opacity-60"
                >
            ...
            <div className="max-h-96 min-w-0 overflow-y-auto rounded-xl border border-slate-200 bg-white">
                                    ...
                                    >
                                        <div className="flex min-w-0 flex-wrap items-center gap-2">
                                            ...
                                            {candidate.tags.map((tag) => (
                                                <span
                                                    key={`tag-${tag}`}
                                                    className="inline-flex min-w-0 break-all rounded-full border border-amber-200 bg-amber-50 px-2 py-0.5 text-[10px] font-mono text-amber-800"
                                                >
                                                    {tag}
                                                </span>
                                            ))}
                                            {candidate.branches.map((branch) => (
                                                <span
                                                    key={`branch-${branch}`}
                                                    className="inline-flex min-w-0 break-all rounded-full border border-sky-200 bg-sky-50 px-2 py-0.5 text-[10px] font-mono text-sky-800"
                                                >
                                                    {branch}
                                                </span>
                                            ))}
