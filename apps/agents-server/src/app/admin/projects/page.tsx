            ...
            <table className="min-w-full text-left text-sm">
                ...
                <tbody>
                    {projects.map((project) => (
                        <tr key={project.id} id={`project-${project.id}`} className="border-b border-gray-100 last:border-0">
                            ...
                            <td className="py-3 pr-4 align-top text-gray-700">{formatResourceBytes(project.sizeBytes)}</td>
