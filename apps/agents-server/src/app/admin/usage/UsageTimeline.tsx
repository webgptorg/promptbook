...
import { formatShortDate, resolveMetricValue } from './usageFormatters';
...
/**
 * Props for the usage timeline chart.
 */
...
/**
 * Usage timeline chart rendered as an SVG sparkline.
 */
export function UsageTimeline(props: UsageTimelineProps) {
 ...
 * @private function of UsageTimeline
 */
