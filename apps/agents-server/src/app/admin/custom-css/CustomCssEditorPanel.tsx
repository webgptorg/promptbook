...
export function CustomCssEditorPanel({
    ...
    return (
        <div className="rounded-lg border border-gray-200 bg-white p-4 dark:border-slate-700 dark:bg-slate-950">
            ...
            {currentFile ? (
                <>
                    <div className="mb-3">
                        <label htmlFor="custom-css-name" className="mb-2 block text-sm font-medium text-gray-700 dark:text-slate-300">
                            File name
                        </label>
                        <input
                            id="custom-css-name"
