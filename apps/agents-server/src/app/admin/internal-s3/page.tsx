...
/**
 * Canonical browser route for the internal S3 admin page.
 *
 * @private internal helper of `/admin/internal-s3`
 */
...
export default async function InternalS3Page({ searchParams }: InternalS3PageProps) {
    ...
    return (
        <div className="container mx-auto space-y-6 px-4 py-8">
            ...
            <S3BrowserPanel browser={browser} route={INTERNAL_S3_ADMIN_ROUTE} />
        ...
        <div className="mt-20 flex flex-col gap-4 md:flex-row md:items-end md:justify-between">
            <div>
                ...
                <p className="mt-1 max-w-3xl text-sm text-gray-500">
                    VPS-wide bundled self-contained S3 (VersityGW) object storage used for uploaded files.
                </p>
            </div>
    ...
    return (
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
            ...
            <InternalS3SummaryCard
                icon={HardDrive}
                label="Total size"
                value={health?.statistics ? formatResourceBytes(health.statistics.totalSizeBytes) : 'Not available'}
