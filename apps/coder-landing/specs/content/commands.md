...
| `SERVER_COMMAND`         | `ptbk coder server --harness claude-code --model fable --thinking-level max --agent agents/developer.book --context AGENTS.md --test npm run test-for-ptbk-coder`            | [Quickstart step 5](../sections/quickstart.md), typed in the [live terminal](../components/live-terminal.md) |
