...
| 8 | [Comparison](./sections/comparison.md)                           | `comparison`    |
| 9 | [Footer](./sections/footer.md)                                   | —               |

## Rules

-   Sections 3–8 are `<section>` elements with the anchor ids above; the header navigation links to them with `#anchor` fragment links (see [`sections/header.md`](./sections/header.md)).
...
-   Sections alternate visual rhythm: Quickstart, Harnesses and Comparison sit on a slightly lighter panel background (`gray-900/30` between hairline borders); the others sit on the page background (see [`design.md`](./design.md)).
...
5. **Decision** (comparison: what ptbk coder adds over the agent you already run) →
6. **Trust** (footer: part of Promptbook).
