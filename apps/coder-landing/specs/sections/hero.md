...
First content block under the header. Two-column on desktop (text left, live terminal right), single column on mobile (text first). A soft Promptbook-Blue gradient glow sits behind the section.
