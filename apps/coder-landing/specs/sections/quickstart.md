...
| 3 | Write your backlog as prompts      | `echo "Add a dark mode toggle to the settings page" > prompts/add-dark-mode.md` (terminal title: `prompts/add-dark-mode.md`) | One task = one markdown file in `prompts/`; written like you would prompt Claude Code or Codex |
