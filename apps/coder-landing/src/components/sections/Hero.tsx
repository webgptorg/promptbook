            ...
            <div className="relative mx-auto grid max-w-6xl gap-12 px-4 pb-20 pt-16 md:pt-24 lg:grid-cols-2 lg:items-center">
                <div>
                    ...
                    <p className="mt-6 max-w-xl text-lg text-gray-300">
                        ...
                        and other coding agents through a queue of plain-markdown prompts. It runs your tests after
                        every task, commits what passes and pushes it. You do not have to be at the keyboard for any of
                        it.
                    </p>
