...
Landing page for [`ptbk coder`](../../src/cli/cli-commands/coder/run.ts) — the Promptbook orchestrator which drives coding agents (Claude Code, OpenAI Codex, GitHub Copilot, Gemini CLI, Qwen Code, opencode, Cline) through a queue of plain-markdown prompts.
