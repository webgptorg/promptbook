 ...
 */
export function findNextTodoPrompt(files: PromptFile[], minimumPriority = 0): PromptSelection | undefined {
    let nextPrompt: PromptSelection | undefined;

    for (const prompt of listRunnablePrompts(files, minimumPriority)) {
