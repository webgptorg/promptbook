...
Budoucnost řízení firem je agentická. Velké jazykové modely dnes dosahují úrovně průměrného zaměstnance v kognitivních úlohách
jako zpracování dokumentů, analýza dat, komunikace. Neznamená to, že nahradí lidi. Znamená to, že **převezmou rutinu**,
aby se firma soustředila na strategická rozhodnutí.

> **Co byste dělali, kdybyste dokázali ušetřit 10 % mzdových nákladů ve své firmě?**

AI Transformace vám pomůže na tuto otázku odpovědět, a začít ji realizovat.

> **Výsledek není prezentace s grafy.**
> Výsledek je **zmapovaná firma, nasazení prvních AI agentů a měřitelná úspora** – do 90 dnů.
...
8:00 – CEO napíše CFO: "Proč byl růst minulý týden jen 2 %?"
9:30 – CFO přepošle dotaz třem vedoucím oddělení.
11:00 – Dva odpověděli, jeden je na home office a neviděl mail.
14:00 – CFO kompiluje čísla do tabulky, hledá kontext.
16:30 – CEO dostane report. Polovina dat chybí. Zeptá se na doplnění.
**Úterý** – CEO má odpověď. Mezitím uběhlo 30+ člověkohodin komunikace.

### Pondělí S agenty

8:00 – CEO otevře dashboard. Agent na každém patře pyramidy už přes noc zpracoval data: agent junior analytik vytáhl čísla z CRM,
agent účetní spároval náklady, agent CFO to sumarizoval do kontextu.
8:05 – CEO vidí odpověď: růst 2 % je v normě, hlavní příčina je sezónní výkyv v segmentu B2B. Doporučení: bez akce.
**8:10** – CEO řeší strategii místo operativy.

> **Rozdíl není v tom, že AI je chytřejší než CFO. Rozdíl je v tom, že čekání na informace trvalo 30 hodin. A teď trvá 5 minut.**

---

## Jak to funguje: vertikála zdola nahoru

Neměníme procesy. **Zrychlujeme je.**

Každý člen týmu, i ten nejníže postavený, může mít svého Promptbook agenta, který mu pomůže o 10 % zrychlit jeho práci.
Samo o sobě jde o drobnou úsporu. Ale jak postupujeme pyramidou vzhůru, **úspory se násobí a získávají kumulativní efekt**:

```
CEO            → agent sumarizuje reporty z celé firmy
  ↑
CFO / COO      → agent připravuje manažerské přehledy
  ↑
Vedoucí týmů   → agent kompiluje data od podřízených
  ↑
Specialisté    → agent zpracovává dokumenty, faktury, dotazy
```
...
> **Promptbook** staví na generativních jazykových modelech. Neřídíme roboty ani kamery.
> Vytváříme AI agenty, kteří **překládají pokyny vedení do konkrétních akcí**:
> připravit report, zpracovat fakturu, odpovědět zákazníkovi, nachystat podklady.
> Fungují jako vrstva mezi CEO a zbytkem firmy.
...
**AI Web s.r.o.** – vyvíjíme **Promptbook**, platformu pro AI agenty. Klienti: Slezská univerzita v Opavě, Městská část Praha 13, Chutoo a další.

**Jiří Jahn** – Ph.D. in Mathematics, IT4I National Supercomputing Centre – jiri@ptbk.io, +420 777 090 067

**Pavol Hejný** – Developer, 15+ let praxe, open-source contributor – pavol@ptbk.io, +420 777 759 767
